...
description: Use when creating or modifying ShipChamber UI text, labels, buttons, placeholders, aria labels, empty states, toasts, dialogs, settings copy, navigation labels, or any user-facing strings.
---
...
'chat.input.placeholder': 'Ask ShipChamber...'
```
...
'Language': 'Language'
'chatLabel': 'Chat'
'askShipChamberDotDotDot': 'Ask ShipChamber...'
```
...
- Product names: `ShipChamber`, `OpenCode`, `GitHub`
