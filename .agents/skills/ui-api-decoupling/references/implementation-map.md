...
- `packages/web/server/lib/opencode/core-routes.js`: installs ShipChamber route families.
...
Explicit ShipChamber routes must register before the generic `/api/*` OpenCode proxy.
