---
name: theme-system
description: Use when creating or modifying ShipChamber UI components, styling, colors, buttons, visual states, themes, or icons.
---
...
- Use semantic ShipChamber theme tokens; never hardcode hex colors or generic Tailwind palette colors.
