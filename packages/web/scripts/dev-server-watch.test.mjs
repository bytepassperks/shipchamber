...
describe('createDevServerWatchCommand', () => {
  it('uses the package default port and disables relay hosting by default', () => {
    ...
    expect(command.spawnOptions.env.SHIPCHAMBER_RELAY_HOST).toBe('off');
