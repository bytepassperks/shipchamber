...
describe('getPullRequestDiff', () => {
  ...
  beforeEach(() => {
    ...
    resolveGitHubRepoFromDirectory.mockResolvedValue({
      repo: { owner: 'shipchamber', repo: 'shipchamber' },
      remoteUrl: 'git@github.com:bytepassperks/shipchamber.git',
    });
  });
  ...
  it('requests the diff for the resolved repository', async () => {
    ...
    expect(result.meta).toEqual({ owner: 'shipchamber', repo: 'shipchamber', number: 2122 });
