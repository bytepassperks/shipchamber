...
${desktopReturn ? `<a class="return" href="shipchamber://focus/linear-auth">Return to ShipChamber</a>
<script>window.location.href = 'shipchamber://focus/linear-auth';</script>` : ''}
</main>
</body>
</html>`;
}
  ...
  app.get('/linear/oauth/callback', async (req, res) => {
    ...
    try {
      ...
      return finish(status, {
        ...
        message: error instanceof Error ? error.message : 'Linear authorization failed. Return to ShipChamber and click Connect again.',
