 ...
 * on a page directly. It publishes a request over the existing ShipChamber
    ...
    request(action, parameters = {}, { timeoutMs = DEFAULT_TIMEOUT_MS, signal } = {}) {
      ...
      if (!listenerCount) {
        ...
        return Promise.reject(new BrowserControlError(
          'No ShipChamber client connected here can control a page. Reading and '
          + 'interacting with a page works when ShipChamber runs as its desktop '
