...
- Chat Markdown rendering is independent: assistant image syntax renders as an
  ...
  image candidates.
- `POST /api/shipchamber/sessions/:sessionId/markdown-image-grants` prepares up to 12
...
The routes are ShipChamber-owned and must be registered before the generic
