...
const PROJECT = '/Users/x/projects/shipchamber';
...
describe('resolving a session directory to its project', () => {
  ...
  test('managed chat session directories share the Chats root store', async () => {
    const chatsRoot = '/Users/x/.config/shipchamber/chats';
    ...
    expect(await resolve('/Users/x/.config/shipchamber/chats-other/session-a')).not.toBe(createProjectIdFromPath(chatsRoot));
  });
