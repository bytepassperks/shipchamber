...
const resolveDataDir = () => (process.env.SHIPCHAMBER_DATA_DIR
...
/**
 * Read a persisted cache object from the ShipChamber data directory.
...
/**
 * Persist a cache object to the ShipChamber data directory with an atomic
