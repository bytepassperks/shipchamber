...
const MOBILE_CONNECTIONS_STORAGE_KEY = 'shipchamber.mobile.connections.v1';
const MOBILE_SECURE_STORAGE_PREFIX = 'shipchamber.mobile.';
const MOBILE_DEVICE_ID_STORAGE_KEY = 'shipchamber.mobile.deviceId';
  ...
  const redeemPairingConnection = React.useCallback(async (payload: PairingConnectionPayload) => {
    ...
    try {
      ...
      const redeemBody = JSON.stringify({
        ...
        clientLabel: 'ShipChamber Mobile',
        clientKind: 'mobile',
        deviceName: 'ShipChamber Mobile',
  ...
  const submitPassword = React.useCallback(async (password: string) => {
    ...
    try {
      ...
      const loginInit = {
        ...
        body: JSON.stringify({ password, trustDevice: true, issueClientToken: true, clientLabel: 'ShipChamber Mobile', clientKind: 'mobile', devicePlatform: mobileDevicePlatform(), dedupeKey: mobileClientDedupeKey() }),
      };
