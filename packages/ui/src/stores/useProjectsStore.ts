...
const getLocalRuntimeOrigin = (): string => {
  ...
  const value = (window as typeof window & { __SHIPCHAMBER_LOCAL_ORIGIN__?: string }).__SHIPCHAMBER_LOCAL_ORIGIN__;
...
const createVSCodeWorkspaceProjects = (
  ...
  if (streamDebugEnabled()) {
    console.log('[ShipChamber][VSCode][projects] Using workspace projects', projects);
  }
...
if (typeof window !== 'undefined') {
  window.addEventListener('shipchamber:settings-synced', (event: Event) => {
