...
const MENU_ACTION_EVENT = 'shipchamber:menu-action';
const CHECK_FOR_UPDATES_EVENT = 'shipchamber:check-for-updates';
...
export const useMenuActions = (
  ...
  const handleAction = React.useCallback(
    (action: MenuAction) => {
      switch (action) {
        ...
        case 'copy': {
          const copyEvent = new Event('shipchamber:copy', { cancelable: true });
  ...
  React.useEffect(() => {
    ...
    listen('shipchamber:menu-action', (evt) => {
    ...
    listen('shipchamber:check-for-updates', () => {
