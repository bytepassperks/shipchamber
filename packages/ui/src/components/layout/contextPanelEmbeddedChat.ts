...
export const EMBEDDED_RUNTIME_BOOTSTRAP_REQUEST = 'shipchamber:embedded-runtime-bootstrap-request';
export const EMBEDDED_RUNTIME_BOOTSTRAP_RESPONSE = 'shipchamber:embedded-runtime-bootstrap-response';
export const EMBEDDED_VISIBILITY_REQUEST = 'shipchamber:embedded-visibility-request';
export const EMBEDDED_VISIBILITY_UPDATE = 'shipchamber:embedded-visibility';
