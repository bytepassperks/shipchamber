...
export const OpenCodeUpdateToast: React.FC = () => {
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('shipchamber:opencode-update-available', onUpdateAvailable);
    return () => {
      cancelled = true;
      for (const timeoutId of timeoutIds) clearTimeout(timeoutId);
      unsubscribeRuntime();
      window.removeEventListener('shipchamber:opencode-update-available', onUpdateAvailable);
    };
