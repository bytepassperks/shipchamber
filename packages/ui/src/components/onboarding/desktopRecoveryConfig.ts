  ...
  switch (variant) {
    ...
    case 'remote-wrong-service': {
      ...
      return {
        ...
        description: `The server at "${host || 'unknown'}" is not running ShipChamber. Verify the address points to an ShipChamber server.`,
    ...
    case 'remote-incompatible': {
      ...
      return {
        ...
        description: `The ShipChamber server at "${host || 'unknown'}" is not compatible with this app version. Update ShipChamber on the server, then try again.`,
