...
type CommandSource = 'shipchamber' | 'opencode' | 'skill';
    ...
    const loadCommands = async () => {
      ...
      try {
        ...
        const builtInCommands: CommandInfo[] = [
          ...(hasSession
            ? [{ id: 'shipchamber:init', name: 'init', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.initDescription'), isBuiltIn: true }]
            : []
          ),
          ...(hasSession  // Show when session exists, not when hasMessages
            ? [
                { id: 'shipchamber:undo', name: 'undo', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.undoDescription'), isBuiltIn: true },
                { id: 'shipchamber:redo', name: 'redo', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.redoDescription'), isBuiltIn: true },
                { id: 'shipchamber:timeline', name: 'timeline', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.timelineDescription'), isBuiltIn: true },
                { id: 'shipchamber:compact', name: 'compact', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.compactDescription'), isBuiltIn: true },
              ]
            : []
          ),
          ...(hasSession
            ? [{ id: 'shipchamber:btw', name: 'btw', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.btwDescription'), isShipChamber: true }]
            : []
          ),
          ...(hasSession
            ? [{ id: 'shipchamber:summary', name: 'summary', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.summaryDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:workspace-review', name: 'workspace-review', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.workspaceReviewDescription'), isShipChamber: true }]
            : []
          ),
          ...(canUseReviewHandoffFlow
            ? [{ id: 'shipchamber:handoff-review', name: 'handoff-review', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.handoffReviewDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:plan-feature', name: 'plan-feature', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.featurePlanDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:craft-goal', name: 'craft-goal', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.craftGoalDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:schedule-task', name: 'schedule-task', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.scheduleTaskDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:catch-up', name: 'catch-up', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.catchUpDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:debug', name: 'debug', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.debugDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:weigh', name: 'weigh', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.weighDescription'), isShipChamber: true }]
            : []
          ),
          ...(canStartSessionCommand
            ? [{ id: 'shipchamber:explore', name: 'explore', source: 'shipchamber' as const, description: t('chat.commandAutocomplete.command.exploreDescription'), isShipChamber: true }]
            : []
          ),
        ];
        ...
        {loading ? (
          ...
          <div>
            {commands.map((command, index) => {
              ...
              const isShipChamberBadge = command.isShipChamber;
              return (
