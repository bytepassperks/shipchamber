...
const MarkdownImageThumbnail: React.FC<{
  ...
  return (
    <button
      ...
      onClick={openPreview}
      data-shipchamber-markdown-image-action="true"
      data-shipchamber-markdown-image-source={candidate.source}
      data-shipchamber-markdown-image-filename={candidate.filename}
    >
      <span className="flex h-[72px] w-[100px] items-center justify-center overflow-hidden rounded-lg border border-border/40 bg-muted/10">
        {image.url && image.status !== 'error' ? (
          <img
            ...
            data-shipchamber-markdown-image="true"
            data-shipchamber-markdown-image-thumbnail="true"
            data-shipchamber-markdown-image-state={image.status}
          />
        ) : (
      ...
      <span
        ...
        title={candidate.filename}
        data-shipchamber-markdown-image-caption="true"
      >
...
export const MarkdownImageGallery: React.FC<{
  ...
  return (
    <div
      ...
      data-shipchamber-markdown-image-gallery="true"
    >
