 ...
 * payloads must be parsed for paths, and ShipChamber's own file tree marks an
...
/** Data type marking a drag that started in ShipChamber's own file tree. */
export const INTERNAL_FILE_PATH_TYPE = 'application/x-shipchamber-file-path';
