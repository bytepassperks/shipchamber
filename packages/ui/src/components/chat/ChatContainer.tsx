...
const CHAT_FORCE_SCROLL_BOTTOM_EVENT = 'shipchamber:chat-force-scroll-bottom';
...
export const ChatContainer: React.FC<ChatContainerProps> = ({
    ...
    React.useEffect(() => {
        ...
        const scopedWindow = window as typeof window & {
            __shipchamberApplyChatSettingsSync?: (payload: { allowPromptingSubagentSessions: boolean }) => void;
        };
        ...
        const handleMessage = (event: MessageEvent) => {
            ...
            if (data?.type !== 'shipchamber:chat-settings-sync'
        ...
        scopedWindow.__shipchamberApplyChatSettingsSync = applySync;
        window.addEventListener('message', handleMessage);
        parentWindow.postMessage({ type: 'shipchamber:chat-settings-request' }, window.location.origin);
        return () => {
            window.removeEventListener('message', handleMessage);
            if (scopedWindow.__shipchamberApplyChatSettingsSync === applySync) {
                delete scopedWindow.__shipchamberApplyChatSettingsSync;
            }
        };
    }, []);
