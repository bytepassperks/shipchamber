...
/**
 * Which ShipChamber capabilities agents are given.
 *
 ...
 */
export const ShipChamberToolsSettings: React.FC = () => {
  const { t } = useI18n();
  ...
  return (
    <SettingsSection title={t('settings.shipchamber.tools.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsCheckboxRow
          settingsItem="sessions.agent-control-tool"
          checked={agentControlToolEnabled}
          onChange={handleAgentControlToolChange}
          label={t('settings.shipchamber.tools.field.agentControlTool')}
          ariaLabel={t('settings.shipchamber.tools.field.agentControlToolAria')}
          info={t('settings.shipchamber.tools.field.agentControlToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.shipchamber.tools.field.agentWebTool')}
          ariaLabel={t('settings.shipchamber.tools.field.agentWebToolAria')}
          info={t('settings.shipchamber.tools.field.agentWebToolInfo')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.shipchamber.tools.field.agentMemoryTool')}
          ariaLabel={t('settings.shipchamber.tools.field.agentMemoryToolAria')}
          info={t('settings.shipchamber.tools.field.agentMemoryToolInfo')}
        />
        ) : null}
      </div>
    </SettingsSection>
