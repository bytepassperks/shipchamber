...
export const GitSettings: React.FC = () => {
  ...
  const viewOptions = React.useMemo(
    () => [
      { id: 'flat' as const, label: t('settings.shipchamber.git.option.flatList') },
      { id: 'tree' as const, label: t('settings.shipchamber.git.option.treeView') },
    ],
    [t]
  );
  ...
  return (
    <SettingsSection title={t('settings.shipchamber.git.title')}>
      <div className={SETTINGS_OPTION_STACK_CLASS}>
        <SettingsControlGroup
          settingsItem="git.changes-view"
          title={t('settings.shipchamber.git.changesViewTitle')}
        >
          <SettingsRadioGroup aria-label={t('settings.shipchamber.git.changesViewAria')}>
            {viewOptions.map((option) => (
              <SettingsRadioOption
                ...
                label={option.label}
                ariaLabel={t('settings.shipchamber.git.optionAria', { option: option.label })}
              />
            ))}
          </SettingsRadioGroup>
        </SettingsControlGroup>
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.shipchamber.git.enableGitmoji')}
          ariaLabel={t('settings.shipchamber.git.enableGitmojiAria')}
        />
        ...
        <SettingsCheckboxRow
          ...
          label={t('settings.shipchamber.git.showGitignored')}
          ariaLabel={t('settings.shipchamber.git.showGitignoredAria')}
        />
      </div>
    </SettingsSection>
  );
