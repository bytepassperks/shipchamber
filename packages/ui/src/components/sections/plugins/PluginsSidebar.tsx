...
export const PluginsSidebar: React.FC<PluginsSidebarProps> = ({
  ...
  React.useEffect(() => {
    ...
    window.addEventListener('shipchamber:settings-open-plugin-add', handleOpenAdd);
    return () => window.removeEventListener('shipchamber:settings-open-plugin-add', handleOpenAdd);
  }, []);
