...
export const ComposerDictation: React.FC<ComposerDictationProps> = ({
    ...
    // The dictation server (WebSocket + STT worker) lives in the ShipChamber
    ...
    React.useEffect(() => {
        ...
        window.addEventListener('shipchamber:dictation-toggle', onToggle);
        return () => window.removeEventListener('shipchamber:dictation-toggle', onToggle);
