...
type ThemeBootstrapWindow = Window & {
  __shipchamberEmbeddedThemeBootstrap?: unknown;
};
...
export const publishEmbeddedThemeBootstrap = (theme: Theme): void => {
  ...
  (window as ThemeBootstrapWindow).__shipchamberEmbeddedThemeBootstrap = theme;
};
...
export const readEmbeddedThemeBootstrap = (): Theme | null => {
  ...
  try {
    ...
    return isValidTheme(parent.__shipchamberEmbeddedThemeBootstrap)
      ? parent.__shipchamberEmbeddedThemeBootstrap
      : null;
  } catch {
    return null;
  }
