...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.timeFormat',
    keywords: ['clock', '12h', '24h'],
  },
  {
    id: 'appearance.week-start',
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.weekStartsOn',
    keywords: ['calendar', 'monday', 'sunday'],
  },
  {
    id: 'appearance.light-theme',
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.lightTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.darkTheme',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.dockBadge',
    descriptionKey: 'settings.shipchamber.visual.field.dockBadgeHint',
    keywords: ['dock', 'badge', 'unread', 'unseen', 'counter', 'count', 'notification', 'macos'],
    // Exactly matches the render guard in ShipChamberVisualSettings: any darwin
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.installAppName',
    descriptionKey: 'settings.shipchamber.visual.field.installAppNameHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.installOrientation',
    descriptionKey: 'settings.shipchamber.visual.field.installOrientationHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.mobileKeyboardMode',
    descriptionKey: 'settings.shipchamber.visual.field.mobileKeyboardModeHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.interfaceFontSize',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.terminalFontSize',
  ...
  },
  {
    ...
    descriptionKey: 'settings.shipchamber.visual.field.terminalShellHint',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.editorFontSize',
    keywords: ['editor', 'font', 'text size', 'code'],
  },
  {
    id: 'appearance.spacing-density',
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.spacingDensity',
    keywords: ['density', 'compact', 'comfortable', 'spacing'],
  },
  {
    id: 'appearance.input-bar-offset',
    page: 'appearance',
    titleKey: 'settings.shipchamber.visual.field.inputBarOffset',
    descriptionKey: 'settings.shipchamber.visual.field.inputBarOffsetTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.visual.field.autoSaveEnabled',
    descriptionKey: 'settings.shipchamber.visual.field.autoSaveEnabledInfo',
    keywords: ['editor', 'autosave', 'auto-save', 'files', 'save'],
  },
  {
    id: 'appearance.file-editor-keymap',
    page: 'general',
    titleKey: 'settings.shipchamber.visual.field.fileEditorKeymap',
    keywords: ['editor', 'vim', 'keymap'],
  },
  {
    id: 'appearance.session-tabs',
    page: 'general',
    titleKey: 'settings.shipchamber.visual.field.sessionTabsGroup',
    descriptionKey: 'settings.shipchamber.visual.field.sessionTabsInfo',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.visual.field.terminalQuickKeys',
    descriptionKey: 'settings.shipchamber.visual.field.terminalQuickKeysTooltip',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.visual.field.sendAnonymousUsageReports',
    descriptionKey: 'settings.shipchamber.visual.field.sendAnonymousUsageReportsHint',
    keywords: ['telemetry', 'analytics'],
  },
  {
    id: 'general.app-links',
    page: 'general',
    titleKey: 'settings.shipchamber.appLinks.title',
    descriptionKey: 'settings.shipchamber.appLinks.info',
    keywords: ['security', 'app link', 'deep link', 'scheme', 'protocol', 'obsidian', 'notion'],
  },
  {
    id: 'chat.render-mode',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.chatRenderMode',
    keywords: ['messages', 'conversation', 'rendering'],
  },
  {
    id: 'chat.message-transport',
    page: 'general',
    titleKey: 'settings.shipchamber.visual.section.messageStreamTransport',
    keywords: ['streaming', 'sse', 'websocket'],
  },
  {
    id: 'chat.session-recap',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.sessionRecap',
    keywords: ['recap', 'assist', 'small model', 'summary'],
  },
  {
    id: 'chat.session-assistance',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.sessionAssistance',
    keywords: ['recap', 'suggestion', 'subagent'],
  },
  {
    id: 'chat.session-suggestion',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.sessionSuggestion',
    keywords: ['suggestion', 'assist', 'small model', 'follow up'],
  },
  {
    id: 'chat.session-goal',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.sessionGoal',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.goal.budgetLabel',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.showReasoningTraces',
    keywords: ['thinking', 'reasoning'],
  },
  {
    id: 'chat.reasoning',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.reasoning',
    keywords: ['thinking', 'traces'],
  },
  {
    id: 'chat.streaming',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.streaming',
    keywords: ['stream', 'scroll'],
  },
  {
    id: 'chat.streaming-auto-follow',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.streamingAutoFollow',
    descriptionKey: 'settings.shipchamber.visual.field.streamingAutoFollowInfo',
    keywords: ['autoscroll', 'auto-scroll', 'follow', 'stick to bottom', 'streaming'],
  },
  {
    id: 'chat.sticky-user-header',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.stickyUserHeader',
    keywords: ['messages', 'header'],
  },
  {
    id: 'chat.prompt-navigator',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.promptNavigatorEnabled',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.collapsibleUserMessages',
    keywords: ['collapse', 'expand', 'clamp', 'long messages', 'user messages'],
  },
  {
    id: 'chat.wide-layout',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.wideChatLayout',
    keywords: ['layout', 'wide', 'messages'],
  },
  {
    id: 'chat.message-appearance',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.messageAppearance',
    keywords: ['layout', 'messages', 'appearance'],
  },
  {
    id: 'chat.code-block-line-wrap',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.codeBlockLineWrap',
    keywords: ['code', 'wrap', 'line wrap', 'markdown'],
  },
  {
    id: 'chat.inline-assistant-actions',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.showSplitAssistantMessageActions',
    descriptionKey: 'settings.shipchamber.visual.field.showSplitAssistantMessageActionsTooltip',
    keywords: ['copy', 'save image', 'read aloud'],
  },
  {
    id: 'chat.draft-starters-visible',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.draftStartersVisible',
    keywords: ['starter', 'starters', 'new session', 'welcome', 'suggestions'],
  },
  {
    id: 'chat.subagent-read-only-banner',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.allowPromptingSubagentSessions',
    keywords: ['subagent', 'read only', 'prompt', 'banner'],
  },
  {
    id: 'chat.tool-file-icons',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.showToolFileIcons',
    keywords: ['tools', 'files', 'icons'],
  },
  {
    id: 'chat.tools-and-files',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.toolsAndFiles',
    keywords: ['tools', 'files', 'dotfiles'],
  },
  {
    id: 'chat.changed-files',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.showTurnChangedFiles',
    keywords: ['changed files', 'turns'],
  },
  {
    id: 'chat.dotfiles',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.showDotfiles',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.followUpBehavior',
    descriptionKey: 'settings.shipchamber.visual.field.followUpBehaviorDescription',
    keywords: ['follow up', 'queue', 'steer', 'send immediately'],
  },
  {
    id: 'chat.input-history-scope',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.inputHistoryScope',
    descriptionKey: 'settings.shipchamber.visual.field.inputHistoryScopeDescription',
    keywords: ['input history', 'composer history', 'global', 'session', 'reuse'],
  },
  {
    id: 'chat.input-history-limit',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.inputHistoryLimit',
    descriptionKey: 'settings.shipchamber.visual.field.inputHistoryLimitDescription',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.persistDraftMessages',
    keywords: ['draft', 'message'],
  },
  {
    id: 'chat.composer',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.section.composer',
    keywords: ['input', 'draft', 'spellcheck', 'paste'],
  },
  {
    id: 'chat.spellcheck',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.enableSpellcheckInTextInputs',
  ...
  },
  {
    ...
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.largeTextPaste',
    descriptionKey: 'settings.shipchamber.visual.field.largeTextPasteHint',
    keywords: ['paste', 'clipboard', 'attachment', 'large', 'text', 'file'],
  },
  {
    id: 'chat.enter-to-send',
    page: 'chat',
    titleKey: 'settings.shipchamber.visual.field.enterToSend',
    descriptionKey: 'settings.shipchamber.visual.field.enterToSendHint',
    keywords: ['enter', 'shift enter', 'send', 'newline'],
  },
  {
    id: 'sessions.default-model',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.field.defaultModel',
    keywords: ['model', 'provider', 'new sessions'],
  },
  {
    id: 'sessions.default-thinking',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.field.defaultThinking',
    keywords: ['thinking', 'reasoning', 'variant'],
  },
  {
    id: 'sessions.default-agent',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.field.defaultAgent',
    keywords: ['agent', 'new sessions'],
  },
  {
    id: 'sessions.deletion-dialog',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.field.showDeletionDialog',
    keywords: ['delete', 'confirmation'],
  },
  {
    id: 'sessions.small-model',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.smallModel.title',
    descriptionKey: 'settings.shipchamber.defaults.smallModel.description',
    keywords: ['small model', 'utility', 'summary', 'recap', 'cheap', 'override'],
  },
  {
    id: 'sessions.walkthrough-model',
    page: 'sessions',
    titleKey: 'settings.shipchamber.defaults.walkthroughModel.title',
    descriptionKey: 'settings.shipchamber.defaults.walkthroughModel.description',
    keywords: ['walkthrough', 'diff', 'review', 'changes', 'structured output', 'model', 'override'],
  },
  {
    id: 'sessions.auto-cleanup',
    page: 'sessions',
    titleKey: 'settings.shipchamber.sessionRetention.field.enableAutoCleanup',
    descriptionKey: 'settings.shipchamber.sessionRetention.tooltip',
    keywords: ['retention', 'archive', 'delete'],
  },
  {
    id: 'sessions.retention-period',
    page: 'sessions',
    titleKey: 'settings.shipchamber.sessionRetention.field.retentionPeriod',
    keywords: ['days', 'cleanup', 'retention'],
  },
  {
    id: 'sessions.retention-action',
    page: 'sessions',
    titleKey: 'settings.shipchamber.sessionRetention.field.whenSessionsExpire',
    keywords: ['archive', 'delete', 'expire'],
  },
  {
    id: 'sessions.desktop-launch-at-login',
    page: 'general',
    titleKey: 'settings.shipchamber.desktopNetwork.field.launchAtLogin',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.launchAtLoginDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.desktopNetwork.field.windowControlsPosition',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.windowControlsPositionDescription',
  ...
  },
  {
    ...
    page: 'appearance',
    titleKey: 'settings.shipchamber.desktopNetwork.field.windowControlsStyle',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.desktopNetwork.field.macMenuBar',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.macMenuBarDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.desktopNetwork.field.minimizeToTray',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.minimizeToTrayDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.desktopNetwork.field.keepAwake',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.keepAwakeDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.desktopPassword.field.password',
    descriptionKey: 'settings.shipchamber.desktopPassword.field.passwordDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.desktopNetwork.field.allowLanAccess',
    descriptionKey: 'settings.shipchamber.desktopNetwork.field.allowLanAccessDescription',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.opencodeCli.field.binaryPath',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.opencodeCli.field.showUpdateNotifications',
  ...
  },
  {
    ...
    page: 'general',
    titleKey: 'settings.shipchamber.tools.field.agentControlTool',
    descriptionKey: 'settings.shipchamber.tools.field.agentControlToolInfo',
    keywords: ['agent', 'tool', 'orchestration', 'shipchamber', 'sessions', 'schedule', 'control'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-web-tool',
    page: 'general',
    titleKey: 'settings.shipchamber.tools.field.agentWebTool',
    descriptionKey: 'settings.shipchamber.tools.field.agentWebToolInfo',
    keywords: ['agent', 'tool', 'web', 'browser', 'page', 'preview', 'shipchamber'],
    isAvailable: (ctx) => !ctx.isVSCode,
  },
  {
    id: 'sessions.agent-memory-tool',
    page: 'general',
    titleKey: 'settings.shipchamber.tools.field.agentMemoryTool',
    descriptionKey: 'settings.shipchamber.tools.field.agentMemoryToolInfo',
    keywords: ['agent', 'tool', 'memory', 'remember', 'recall', 'preferences', 'shipchamber'],
  ...
  },
  {
    id: 'git.changes-view',
    page: 'git',
    titleKey: 'settings.shipchamber.git.changesViewTitle',
    keywords: ['changes', 'flat list', 'tree view'],
  },
  {
    id: 'git.gitmoji',
    page: 'git',
    titleKey: 'settings.shipchamber.git.enableGitmoji',
    keywords: ['commit', 'emoji'],
  },
  {
    id: 'git.gitignored-files',
    page: 'git',
    titleKey: 'settings.shipchamber.git.showGitignored',
  ...
  },
  {
    ...
    page: 'projects',
    titleKey: 'settings.shipchamber.worktrees.setup.waitForCommands',
  ...
  },
  {
    ...
    page: 'shortcuts',
    titleKey: 'settings.shipchamber.keyboardShortcuts.title',
    descriptionKey: 'settings.shipchamber.keyboardShortcuts.tooltip',
  ...
  },
  {
    id: 'tunnel.provider',
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.field.provider',
    descriptionKey: 'settings.shipchamber.tunnel.description',
  ...
  },
  {
    id: 'tunnel.type',
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.field.tunnelType',
  ...
  },
  {
    id: 'tunnel.ttl',
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.field.connectLinkTtl',
    descriptionKey: 'settings.shipchamber.tunnel.field.tunnelSessionTtl',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.section.savedManagedRemoteTunnels',
  ...
  },
  {
    ...
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.field.configurationFile',
    descriptionKey: 'settings.shipchamber.tunnel.note.managedLocalUsesConfig',
  ...
  },
  {
    id: 'tunnel.start',
    page: 'tunnel',
    titleKey: 'settings.shipchamber.tunnel.actions.startTunnel',
    descriptionKey: 'settings.shipchamber.tunnel.note.connectLinksOneTime',
