 ...
 * it as `window.__SHIPCHAMBER_DESKTOP_BOOT_OUTCOME__`. This module provides
...
export function getInjectedBootOutcome(): DesktopBootOutcome | null {
  ...
  const raw = (window as { __SHIPCHAMBER_DESKTOP_BOOT_OUTCOME__?: unknown })
    .__SHIPCHAMBER_DESKTOP_BOOT_OUTCOME__;
