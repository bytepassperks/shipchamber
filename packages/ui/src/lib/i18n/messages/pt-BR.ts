...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instale o ShipChamber para acessar mais rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Dispensar",
  "pwa.installPrompt.started": "Instalação iniciada",
  "pwa.installPrompt.installed": "ShipChamber instalado",
  ...
  "mobile.connect.welcome.title": "Conectar ao ShipChamber",
  ...
  "mobile.connect.password.placeholder": "Senha do ShipChamber",
  ...
  "mobile.connect.scan.invalid": "Esse código QR não é um código de conexão do ShipChamber.",
  ...
  "mobile.connect.error.unreachable": "Não foi possível acessar esse servidor ShipChamber.",
  ...
  "sessions.sidebar.footer.actions.aboutShipChamber": "Sobre o ShipChamber",
  ...
  "walkthrough.blocked.serverUnsupported.description": "O servidor ShipChamber ao qual este app está conectado não respondeu à API de walkthrough, ou seja, é mais antigo que o app. Atualize o servidor para 1.18 ou mais recente e atualize a visualização.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} roda na máquina onde o ShipChamber está e não foi possível abrir a conexão com ela. Nada da sua própria máquina é mostrado aqui.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Eles rodam na máquina que hospeda o ShipChamber. Abri-los exige o aplicativo desktop.",
  ...
  "contextPanel.browser.trustNotice": "As páginas abertas aqui são executadas com acesso total ao ShipChamber — necessário para inspeção e capturas de tela. Abra apenas sites confiáveis: uma página maliciosa pode ler seus dados ou agir em seu nome.",
  ...
  "filesView.editor.binaryFileDescription": "Este arquivo é binário e não pode ser editado no ShipChamber. Baixe-o para abrir em outro aplicativo.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "ShipChamber precisa acessar esta pasta.",
  ...
  "aboutDialog.shipChamberVersionLabel": "Versão do ShipChamber {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Inclui o estado do ShipChamber, a integridade do OpenCode, diretórios e projetos.",
  ...
  "helpDialog.description": "Use estes atalhos de teclado para navegar pelo ShipChamber com eficiência",
  ...
  "header.actions.openAppMenu": "Menu do ShipChamber",
  "header.actions.openAppMenuAria": "Abrir menu do ShipChamber",
  ...
  "session.newWorktree.toast.fetchSourceFailed": "Não foi possível buscar do remoto — criado a partir do estado local",
  ...
  "sessionAuth.error.networkDescription": "Não foi possível verificar a sessão da interface. Se você estiver abrindo o ShipChamber de outro dispositivo na sua rede local, ative o Desktop Network Access no app para desktop e use o endereço LAN mostrado em Configurações.",
  ...
  "desktopHostSwitcher.description": "Alterne entre Local e o servidor remoto do ShipChamber",
  ...
  "multiRun.window.description": "Janela do ShipChamber Multi-Run.",
  ...
  "onboarding.chooser.title": "Boas-vindas ao ShipChamber",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Se o ShipChamber não detectar o OpenCode automaticamente, defina o caminho do executável a seguir.",
  "onboarding.localSetup.intro": "OpenCode é o coração do ShipChamber. Instale-o para começar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Salve nas configurações do ShipChamber e recarregue configurações do OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Digite o endereço de um servidor do ShipChamber para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugestões: verifique se a URL aponta para um servidor ShipChamber ou entre em contato com o administrador do servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instância está executando uma versão diferente do ShipChamber. Você pode se conectar, mas atualize os dois apps se algo não funcionar.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "O servidor está executando ShipChamber, mas não é compatível com esta versão do app. Atualize o ShipChamber no servidor e tente novamente.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "O servidor respondeu, mas não está executando ShipChamber. Verifique se o endereço aponta para um servidor ShipChamber.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "O servidor em \"{host}\" não está executando ShipChamber. Verifique se o endereço aponta para um servidor ShipChamber.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Atualização do servidor necessária",
  "onboarding.desktopRecovery.remoteIncompatible.description": "O servidor ShipChamber em \"{host}\" não é compatível com esta versão do app. Atualize o ShipChamber no servidor e tente novamente.",
  ...
  "startup.initRecovery.description": "O ShipChamber não conseguiu concluir a inicialização. Verifique se o servidor está em execução e tente novamente.",
  ...
  "updateDialog.header.updating": "Atualizando ShipChamber...",
  ...
  "updateDialog.error.takingLonger": "A atualização está demorando mais do que o esperado. Aguarde um pouco e atualize, ou execute: shipchamber update",
  "updateDialog.error.signatureRejected": "A atualização baixada foi rejeitada: a assinatura de código não corresponde a esta instalação. Isso costuma significar que a cópia em execução não foi instalada a partir de uma versão oficial assinada. Instale o ShipChamber a partir de uma versão oficial e atualize novamente.",
  "updateDialog.error.updaterDisabled": "O atualizador parou após uma instalação com falha. Feche o ShipChamber, abra-o de novo e tente atualizar outra vez.",
  "updateDialog.error.restartFailed": "Não foi possível reiniciar para instalar a atualização.",
  "updateDialog.error.restartUnavailable": "Instalar a atualização exige o aplicativo de desktop do ShipChamber.",
  "mobileUpdate.toast.available.title": "Atualização do ShipChamber disponível",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantenha o ShipChamber aberto.",
  ...
  "shipChamberLogo.aria.logo": "Logo do ShipChamber",
