...
export const dict: Record<I18nKey, string> = {
  ...
  "pwa.installPrompt.description": "Instala ShipChamber para acceder más rápido",
  "pwa.installPrompt.action": "Instalar",
  "pwa.installPrompt.dismiss": "Descartar",
  "pwa.installPrompt.started": "Instalación iniciada",
  "pwa.installPrompt.installed": "ShipChamber se instaló",
  ...
  "mobile.connect.welcome.title": "Conéctate a ShipChamber",
  ...
  "mobile.connect.password.placeholder": "Contraseña de ShipChamber",
  ...
  "mobile.connect.scan.invalid": "Ese código QR no es un código de conexión de ShipChamber.",
  ...
  "mobile.connect.relay.badge": "a través de ShipChamber Relay",
  ...
  "mobile.connect.error.unreachable": "No se pudo conectar con ese servidor de ShipChamber.",
  ...
  "sessions.sidebar.footer.actions.aboutShipChamber": "Acerca de ShipChamber",
  ...
  "sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle": "No se pudo eliminar el worktree «{name}»",
  "sessions.sidebar.sessionDialogs.worktree.removingTitle": "Eliminando el worktree «{name}»…",
  "sessions.sidebar.sessionDialogs.worktree.removedTitle": "Worktree «{name}» eliminado",
  ...
  "walkthrough.blocked.serverUnsupported.description": "El servidor de ShipChamber al que está conectada esta app no respondió a la API de walkthrough, así que es más antiguo que la app. Actualiza el servidor a 1.18 o posterior y vuelve a intentarlo.",
  ...
  "contextPanel.browser.tunnelFailedHint": "{url} se ejecuta en la máquina donde está ShipChamber y no se pudo abrir la conexión con ella. Aquí no se muestra nada de tu propia máquina.",
  ...
  "contextPanel.browser.devServers.remoteOnly": "Se ejecutan en la máquina que aloja ShipChamber. Abrirlos requiere la aplicación de escritorio.",
  ...
  "contextPanel.browser.trustNotice": "Las páginas que abras aquí se ejecutan con acceso completo a ShipChamber: necesario para la inspección y las capturas. Abre solo sitios de confianza: una página maliciosa podría leer tus datos o actuar en tu nombre.",
  ...
  "filesView.editor.binaryFileDescription": "Este archivo es binario y no se puede editar en ShipChamber. Descárgalo para abrirlo con otra aplicación.",
  ...
  "directoryExplorerDialog.browse.permissionDenied": "ShipChamber necesita acceso a esta carpeta.",
  ...
  "aboutDialog.shipChamberVersionLabel": "Versión de ShipChamber {version}",
  ...
  "aboutDialog.diagnosticsDescription": "Incluye el estado de ShipChamber, el estado de OpenCode, directorios y proyectos.",
  ...
  "helpDialog.description": "Usa estos atajos de teclado para navegar por ShipChamber de manera eficiente",
  ...
  "header.actions.openAppMenu": "Menú de ShipChamber",
  "header.actions.openAppMenuAria": "Abrir menú de ShipChamber",
  ...
  "sessionAuth.error.networkDescription": "No pudimos verificar la sesión de la UI. Si abres ShipChamber desde otro dispositivo en tu red local, activa Desktop Network Access en la app de escritorio y usa la dirección LAN que aparece en Ajustes.",
  ...
  "sessionAuth.locked.unlockTitle": "Desbloquear ShipChamber",
  ...
  "desktopHostSwitcher.description": "Cambia entre Local y el servidor remoto de ShipChamber",
  ...
  "multiRun.window.description": "Ventana de ShipChamber Multi-Run.",
  ...
  "onboarding.chooser.title": "Bienvenido a ShipChamber",
  ...
  "onboarding.localSetup.windows.stepSetBinaryPath": "Si ShipChamber no detecta OpenCode automáticamente, establece la ruta del ejecutable a continuación.",
  "onboarding.localSetup.intro": "OpenCode es el corazón de ShipChamber. Instálalo para empezar.",
  ...
  "onboarding.localSetup.helper.saveAndReload": "Guarda en la configuración de ShipChamber y recarga la configuración de OpenCode.",
  ...
  "onboarding.remoteConnection.description": "Introduce la dirección de un servidor de ShipChamber para conectar.",
  ...
  "onboarding.remoteConnection.status.suggestionsWrongService": "Sugerencias: Verifica que la URL apunte a un servidor ShipChamber o contacta al administrador del servidor.",
  ...
  "onboarding.remoteConnection.probe.updateRecommendedMessage": "Esta instancia ejecuta una versión diferente de ShipChamber. Puedes conectarte, pero actualiza ambas apps si algo no funciona.",
  "onboarding.remoteConnection.probe.incompatibleMessage": "El servidor ejecuta ShipChamber pero no es compatible con esta versión de la app. Actualiza ShipChamber en el servidor y vuelve a intentarlo.",
  "onboarding.remoteConnection.probe.wrongServiceMessage": "El servidor respondió pero no está ejecutando ShipChamber. Verifica que la dirección apunte a un servidor ShipChamber.",
  ...
  "onboarding.desktopRecovery.incompatibleServer.description": "El servidor en \"{host}\" no está ejecutando ShipChamber. Verifica que la dirección apunte a un servidor ShipChamber.",
  "onboarding.desktopRecovery.remoteIncompatible.title": "Actualización del servidor requerida",
  "onboarding.desktopRecovery.remoteIncompatible.description": "El servidor ShipChamber en \"{host}\" no es compatible con esta versión de la app. Actualiza ShipChamber en el servidor y vuelve a intentarlo.",
  ...
  "startup.initRecovery.description": "ShipChamber no pudo completar la inicialización. Comprueba que el servidor esté en ejecución y vuelve a intentarlo.",
  ...
  "updateDialog.header.updating": "Actualizando ShipChamber...",
  ...
  "updateDialog.error.takingLonger": "La actualización está tardando más de lo esperado. Espera un poco y refresca, o ejecuta: shipchamber update",
  "updateDialog.error.signatureRejected": "La actualización descargada fue rechazada: su firma de código no coincide con esta instalación. Normalmente significa que la copia en ejecución no se instaló desde una versión oficial firmada. Instala ShipChamber desde una versión oficial y vuelve a actualizar.",
  "updateDialog.error.updaterDisabled": "El actualizador se detuvo tras una instalación fallida. Cierra ShipChamber, ábrelo de nuevo y reintenta la actualización.",
  "updateDialog.error.restartFailed": "No se pudo reiniciar para instalar la actualización.",
  "updateDialog.error.restartUnavailable": "Instalar la actualización requiere la aplicación de escritorio de ShipChamber.",
  "mobileUpdate.toast.available.title": "Actualización de ShipChamber disponible",
  ...
  "opencodeUpdate.toast.upgrading.description": "Mantén ShipChamber abierto.",
  ...
  "shipChamberLogo.aria.logo": "Logo de ShipChamber",
