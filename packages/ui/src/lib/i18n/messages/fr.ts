...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Installez ShipChamber pour un accès plus rapide',
  'pwa.installPrompt.action': 'Installer',
  'pwa.installPrompt.dismiss': 'Ignorer',
  'pwa.installPrompt.started': 'Installation démarrée',
  'pwa.installPrompt.installed': 'ShipChamber installé',
  ...
  'sessions.sidebar.footer.actions.aboutShipChamber': 'À propos de ShipChamber',
  ...
  'sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle': 'Échec de la suppression du worktree « {name} »',
  'sessions.sidebar.sessionDialogs.worktree.removingTitle': 'Suppression du worktree « {name} »…',
  'sessions.sidebar.sessionDialogs.worktree.removedTitle': 'Worktree « {name} » supprimé',
  ...
  'walkthrough.blocked.serverUnsupported.description': "Le serveur ShipChamber auquel cette application est connectée n'a pas répondu à l'API walkthrough : il est donc plus ancien que l'application. Mettez le serveur à jour en 1.18 ou plus récent, puis actualisez.",
  ...
  'filesView.editor.binaryFileDescription': 'Ce fichier est binaire et ne peut pas être modifié dans ShipChamber. Téléchargez-le pour l’ouvrir avec une autre application.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ShipChamber doit accéder à ce dossier.',
  ...
  'aboutDialog.shipChamberVersionLabel': 'Version ShipChamber {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Comprend l’état ShipChamber, l’état de santé OpenCode, les répertoires et les projets.',
  ...
  'helpDialog.description': 'Utilisez ces raccourcis clavier pour naviguer efficacement dans ShipChamber',
  ...
  'header.actions.openAppMenu': 'Menu de ShipChamber',
  'header.actions.openAppMenuAria': 'Ouvrir le menu ShipChamber',
  ...
  'sessionAuth.error.networkDescription': 'Nous n\'avons pas pu vérifier la session d\'interface utilisateur. Si vous ouvrez ShipChamber depuis un autre appareil sur votre réseau local, activez l\'accès au réseau du bureau dans l\'application de bureau et utilisez l\'adresse LAN indiquée dans les paramètres.',
  ...
  'sessionAuth.locked.unlockTitle': 'Débloquez ShipChamber',
  ...
  'desktopHostSwitcher.description': 'Basculer entre les serveurs ShipChamber locaux et distants',
  ...
  'multiRun.window.description': 'Fenêtre multi-exécution ShipChamber.',
  ...
  'onboarding.chooser.title': 'Bienvenue sur ShipChamber',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Si ShipChamber ne détecte pas automatiquement OpenCode, définissez le chemin binaire ci-dessous.',
  'onboarding.localSetup.intro': 'OpenCode est le cœur de ShipChamber — installez-le pour commencer.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Enregistre dans les paramètres ShipChamber et recharge la configuration OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Saisissez l\'adresse d\'un serveur ShipChamber auquel vous connecter.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions : vérifiez que l’URL pointe vers un serveur ShipChamber ou contactez l\'administrateur du serveur.',
  ...
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Le serveur a répondu mais n\'exécute pas ShipChamber. Vérifiez que l\'adresse pointe vers un serveur ShipChamber.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Le serveur « {host} » n\'exécute pas ShipChamber. Vérifiez que l\'adresse pointe vers un serveur ShipChamber.',
  ...
  'startup.initRecovery.description': 'ShipChamber n\'a pas pu terminer l\'initialisation. Vérifiez que le serveur est en cours d\'exécution, puis réessayez.',
  ...
  'updateDialog.header.updating': 'Mise à jour de ShipChamber...',
  ...
  'updateDialog.error.takingLonger': 'La mise à jour prend plus de temps que prévu. Attendez un peu et actualisez, ou exécutez : shipchamber update',
  'updateDialog.error.signatureRejected': 'La mise à jour téléchargée a été rejetée : sa signature de code ne correspond pas à cette installation. Cela signifie généralement que la copie en cours n’a pas été installée depuis une version officielle signée. Installez ShipChamber depuis une version officielle, puis relancez la mise à jour.',
  'updateDialog.error.updaterDisabled': 'Le programme de mise à jour s’est arrêté après une installation échouée. Quittez ShipChamber, rouvrez-le, puis réessayez la mise à jour.',
  'updateDialog.error.restartFailed': 'Impossible de redémarrer pour installer la mise à jour.',
  'updateDialog.error.restartUnavailable': 'L’installation de la mise à jour nécessite l’application de bureau ShipChamber.',
  'mobileUpdate.toast.available.title': 'Mise à jour ShipChamber disponible',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Gardez ShipChamber ouvert.',
  ...
  'mobile.connect.welcome.title': 'Se connecter à ShipChamber',
  ...
  'mobile.connect.password.placeholder': 'Mot de passe ShipChamber',
  ...
  'mobile.connect.scan.invalid': 'Ce code QR n\'est pas un code de connexion ShipChamber.',
  ...
  'mobile.connect.relay.badge': 'via ShipChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Impossible de joindre ce serveur ShipChamber.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} tourne sur la machine où se trouve ShipChamber, et la connexion vers elle n’a pas pu être ouverte. Rien de votre propre machine n’est affiché ici.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Ils tournent sur la machine qui héberge ShipChamber. Les ouvrir nécessite l’application de bureau.',
  ...
  'contextPanel.browser.trustNotice': 'Les pages ouvertes ici s’exécutent avec un accès complet à ShipChamber — nécessaire pour l’inspection et les captures d’écran. N’ouvrez que des sites de confiance : une page malveillante pourrait lire vos données ou agir en votre nom.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Cette instance utilise une version différente d’ShipChamber. Vous pouvez vous connecter, mais mettez les deux applications à jour si quelque chose ne fonctionne pas.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Le serveur exécute ShipChamber mais n’est pas compatible avec cette version de l’application. Mettez ShipChamber à jour sur le serveur, puis réessayez.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Mise à jour du serveur requise',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Le serveur ShipChamber à l’adresse « {host} » n’est pas compatible avec cette version de l’application. Mettez ShipChamber à jour sur le serveur, puis réessayez.',
