...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'Zainstaluj ShipChamber, aby mieć szybszy dostęp',
  'pwa.installPrompt.action': 'Zainstaluj',
  'pwa.installPrompt.dismiss': 'Odrzuć',
  'pwa.installPrompt.started': 'Instalacja rozpoczęta',
  'pwa.installPrompt.installed': 'ShipChamber został zainstalowany',
  ...
  'mobile.connect.welcome.title': 'Połącz z ShipChamber',
  ...
  'mobile.connect.password.placeholder': 'Hasło ShipChamber',
  ...
  'mobile.connect.scan.invalid': 'Ten kod QR nie jest kodem połączenia ShipChamber.',
  ...
  'mobile.connect.relay.badge': 'przez ShipChamber Relay',
  ...
  'mobile.connect.error.unreachable': 'Nie udało się połączyć z tym serwerem ShipChamber.',
  ...
  'sessions.sidebar.footer.actions.aboutShipChamber': 'O ShipChamber',
  ...
  'multiRun.window.description': 'Okno wielokrotnego uruchomienia ShipChamber.',
  ...
  'onboarding.chooser.title': 'Witaj w ShipChamber',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'Jeśli ShipChamber nie wykryje OpenCode automatycznie, ustaw ścieżkę binarki poniżej.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Zapisuje do ustawień ShipChamber i przeładowuje konfigurację OpenCode.',
  ...
  'onboarding.remoteConnection.description': 'Wpisz adres serwera ShipChamber aby się połączyć.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Sugestie: Zweryfikuj czy URL wskazuje na serwer ShipChamber, lub skontaktuj się z administratorem serwera.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'Ta instancja używa innej wersji ShipChamber. Możesz się połączyć, ale zaktualizuj obie aplikacje, jeśli coś nie działa.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Serwer uruchamia ShipChamber, ale nie jest zgodny z tą wersją aplikacji. Zaktualizuj ShipChamber na serwerze i spróbuj ponownie.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Serwer odpowiedział, ale nie uruchomiono na nim ShipChamber. Zweryfikuj czy adres wskazuje na serwer ShipChamber.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'Serwer pod adresem "{host}" nie uruchamia ShipChamber. Zweryfikuj czy adres wskazuje na serwer ShipChamber.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Wymagana aktualizacja serwera',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'Serwer ShipChamber pod adresem "{host}" nie jest zgodny z tą wersją aplikacji. Zaktualizuj ShipChamber na serwerze i spróbuj ponownie.',
  ...
  'startup.initRecovery.description': 'ShipChamber nie mógł dokończyć inicjalizacji. Sprawdź czy serwer działa, następnie spróbuj ponownie.',
  ...
  'aboutDialog.diagnosticsDescription': 'Zawiera stan ShipChamber, kondycję OpenCode, katalogi i projekty.',
  ...
  'aboutDialog.shipChamberVersionLabel': 'Wersja ShipChamber {version}',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'Serwer ShipChamber, z którym połączona jest ta aplikacja, nie odpowiedział na API walkthroughu — jest więc starszy niż aplikacja. Zaktualizuj serwer do wersji 1.18 lub nowszej i odśwież.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} działa na maszynie, na której jest ShipChamber, i nie udało się otworzyć do niej połączenia. Nic z twojej własnej maszyny nie jest tu pokazywane.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'Działają na komputerze, na którym uruchomiony jest ShipChamber. Do ich otwarcia potrzebna jest aplikacja desktopowa.',
  ...
  'contextPanel.browser.trustNotice': 'Strony otwierane tutaj działają z pełnym dostępem do ShipChamber — jest to wymagane do inspekcji i zrzutów ekranu. Otwieraj tylko zaufane witryny: złośliwa strona może odczytać Twoje dane lub działać w Twoim imieniu.',
  ...
  'desktopHostSwitcher.description': 'Przełączaj między lokalnymi i zdalnymi serwerami ShipChamber',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ShipChamber potrzebuje dostępu do tego folderu.',
  ...
  'filesView.editor.binaryFileDescription': 'Ten plik jest binarny i nie można go edytować w ShipChamber. Pobierz go, aby otworzyć w innej aplikacji.',
  ...
  'header.actions.openAppMenu': 'Menu ShipChamber',
  'header.actions.openAppMenuAria': 'Otwórz menu ShipChamber',
  ...
  'helpDialog.description': 'Użyj tych skrótów klawiaturowych, aby sprawnie poruszać się po ShipChamber.',
  ...
  'shipChamberLogo.aria.logo': 'Logo ShipChamber',
  ...
  'sessionAuth.error.networkDescription': 'Nie udało się zweryfikować sesji UI. Jeśli otwierasz ShipChamber z innego urządzenia w sieci lokalnej, włącz Desktop Network Access w aplikacji desktopowej i użyj adresu LAN widocznego w Ustawieniach.',
  ...
  'sessionAuth.locked.unlockTitle': 'Odblokuj ShipChamber',
  ...
  'updateDialog.error.takingLonger': 'Aktualizacja trwa dłużej niż oczekiwano. Poczekaj chwilę i odśwież albo uruchom: shipchamber update',
  'updateDialog.error.signatureRejected': 'Pobrana aktualizacja została odrzucona: jej podpis kodu nie pasuje do tej instalacji. Zwykle oznacza to, że uruchomiona kopia nie pochodzi z oficjalnego podpisanego wydania. Zainstaluj ShipChamber z oficjalnego wydania i zaktualizuj ponownie.',
  'updateDialog.error.updaterDisabled': 'Aktualizator zatrzymał się po nieudanej instalacji. Zamknij ShipChamber, otwórz go ponownie i spróbuj zaktualizować jeszcze raz.',
  'updateDialog.error.restartFailed': 'Nie udało się uruchomić ponownie, aby zainstalować aktualizację.',
  'updateDialog.error.restartUnavailable': 'Instalacja aktualizacji wymaga aplikacji desktopowej ShipChamber.',
  'updateDialog.error.updateFailed': 'Aktualizacja nie powiodła się',
  'mobileUpdate.toast.available.title': 'Dostępna aktualizacja ShipChamber',
  ...
  'updateDialog.header.updating': 'Aktualizowanie ShipChamber...',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Pozostaw ShipChamber otwarte.',
  ...
  'onboarding.localSetup.intro': 'OpenCode to serce ShipChamber — zainstaluj je, aby zacząć.',
  ...
  'settings.shipchamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Otwórz oś czasu',
  ...
  'settings.shipchamber.visual.field.mobileKeyboardModeAria': 'Tryb klawiatury mobilnej',
  'settings.shipchamber.visual.field.selectMobileKeyboardModePlaceholder': 'Wybierz tryb klawiatury mobilnej',
  'settings.shipchamber.visual.actions.resetMobileKeyboardModeAria': 'Resetuj tryb klawiatury mobilnej',
  'settings.shipchamber.visual.option.mobileKeyboardMode.native.label': 'Natywny',
  'settings.shipchamber.visual.option.mobileKeyboardMode.native.description': 'Użyj domyślnego zachowania przeglądarki/systemu.',
  'settings.shipchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Zmień rozmiar zawartości',
  'settings.shipchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Dopasuj układ tak, aby zawartość pozostała widoczna ponad klawiaturą.',
