...
export const dict = {
  ...
  'pwa.installPrompt.description': 'Install ShipChamber for quicker access',
  'pwa.installPrompt.action': 'Install',
  'pwa.installPrompt.dismiss': 'Dismiss',
  'pwa.installPrompt.started': 'Install started',
  'pwa.installPrompt.installed': 'ShipChamber installed',
  ...
  'mobile.connect.welcome.title': 'Connect to ShipChamber',
  ...
  'mobile.connect.password.placeholder': 'ShipChamber password',
  ...
  'mobile.connect.scan.invalid': 'That QR code is not an ShipChamber connection code.',
  ...
  'mobile.connect.error.unreachable': 'Could not reach that ShipChamber server.',
  ...
  'sessions.sidebar.footer.actions.aboutShipChamber': 'About ShipChamber',
  ...
  'sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle': 'Failed to remove worktree “{name}”',
  'sessions.sidebar.sessionDialogs.worktree.removingTitle': 'Removing worktree “{name}”…',
  'sessions.sidebar.sessionDialogs.worktree.removedTitle': 'Worktree “{name}” removed',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'The ShipChamber server this app is connected to did not answer the walkthrough API, which means it is older than the app. Update the server to 1.18 or newer, then refresh.',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} runs on the machine ShipChamber is on, and the connection to it could not be opened. Nothing from your own machine is shown here.',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'These run on the machine hosting ShipChamber. Opening them needs the desktop app.',
  ...
  'contextPanel.browser.trustNotice': 'Pages opened here run with full access to ShipChamber — needed for inspect and screenshots. Only open sites you trust: a malicious page could read your data or act on your behalf.',
  ...
  'filesView.editor.binaryFileDescription': 'This file is binary and cannot be edited in ShipChamber. Download it to open with another app.',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ShipChamber needs access to this folder.',
  ...
  'aboutDialog.shipChamberVersionLabel': 'ShipChamber version {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'Includes ShipChamber state, OpenCode health, directories, and projects.',
  ...
  'helpDialog.description': 'Use these keyboard shortcuts to navigate ShipChamber efficiently',
  ...
  'header.actions.openAppMenu': 'ShipChamber menu',
  'header.actions.openAppMenuAria': 'Open ShipChamber menu',
  ...
  'sessionAuth.error.networkDescription': 'We could not verify the UI session. If you\'re opening ShipChamber from another device on your local network, make sure Desktop Network Access is enabled on the desktop app and use the LAN address shown in Settings.',
  ...
  'sessionAuth.locked.unlockTitle': 'Unlock ShipChamber',
  ...
  'desktopHostSwitcher.description': 'Switch between Local and remote ShipChamber servers',
  ...
  'multiRun.window.description': 'ShipChamber Multi-Run window.',
  ...
  'onboarding.chooser.title': 'Welcome to ShipChamber',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'If ShipChamber does not detect OpenCode automatically, set the binary path below.',
  'onboarding.localSetup.intro': 'OpenCode is the heart of ShipChamber — install it to get started.',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'Saves to ShipChamber settings and reloads OpenCode configuration.',
  ...
  'onboarding.remoteConnection.description': 'Enter the address of an ShipChamber server to connect to.',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'Suggestions: Verify the URL points to an ShipChamber server, or contact the server administrator.',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'This instance is running a different ShipChamber version. You can connect, but update both apps if something does not work.',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'Server is running ShipChamber but is not compatible with this app version. Update ShipChamber on the server, then try again.',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'Server responded but is not running ShipChamber. Verify the address points to an ShipChamber server.',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': 'The server at "{host}" is not running ShipChamber. Verify the address points to an ShipChamber server.',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'Server Update Required',
  'onboarding.desktopRecovery.remoteIncompatible.description': 'The ShipChamber server at "{host}" is not compatible with this app version. Update ShipChamber on the server, then try again.',
  ...
  'startup.initRecovery.description': 'ShipChamber could not finish initialization. Check that the server is running, then retry.',
  ...
  'updateDialog.header.updating': 'Updating ShipChamber...',
  ...
  'updateDialog.error.takingLonger': 'Update is taking longer than expected. Wait a bit and refresh, or run: shipchamber update',
  'updateDialog.error.signatureRejected': 'The downloaded update was rejected: its code signature does not match this installation. This usually means the running copy was not installed from an official signed release. Install ShipChamber from an official release, then update again.',
  'updateDialog.error.updaterDisabled': 'The updater stopped after a failed install. Quit ShipChamber, open it again, and retry the update.',
  'updateDialog.error.restartFailed': 'Could not restart to install the update.',
  'updateDialog.error.restartUnavailable': 'Installing the update requires the ShipChamber desktop app.',
  'mobileUpdate.toast.available.title': 'ShipChamber update available',
  ...
  'opencodeUpdate.toast.upgrading.description': 'Keep ShipChamber open.',
  ...
  'shipChamberLogo.aria.logo': 'ShipChamber logo',
