...
export const dict: Record<I18nKey, string> = {
  ...
  'pwa.installPrompt.description': 'ShipChamberをインストールしてすぐにアクセス',
  'pwa.installPrompt.action': 'インストール',
  'pwa.installPrompt.dismiss': '閉じる',
  'pwa.installPrompt.started': 'インストールを開始しました',
  'pwa.installPrompt.installed': 'ShipChamberをインストールしました',
  ...
  'mobile.connect.welcome.title': 'ShipChamber に接続',
  ...
  'mobile.connect.password.placeholder': 'ShipChamber のパスワード',
  ...
  'mobile.connect.relay.badge': 'ShipChamber Relay 経由',
  ...
  'mobile.connect.error.unreachable': 'その ShipChamber サーバーに接続できませんでした。',
  ...
  'mobile.connect.scan.invalid': 'その QR コードは ShipChamber の接続コードではありません。',
  ...
  'sessions.sidebar.footer.actions.aboutShipChamber': 'ShipChamberについて',
  ...
  'sessions.sidebar.sessionDialogs.worktree.errorRemoveTitle': 'ワークツリー「{name}」の削除に失敗しました',
  'sessions.sidebar.sessionDialogs.worktree.removingTitle': 'ワークツリー「{name}」を削除しています…',
  'sessions.sidebar.sessionDialogs.worktree.removedTitle': 'ワークツリー「{name}」を削除しました',
  ...
  'walkthrough.blocked.serverUnsupported.description': 'このアプリが接続している ShipChamber サーバーはウォークスルー API に応答しませんでした。つまりアプリより古いバージョンです。サーバーを 1.18 以降に更新してから再読み込みしてください。',
  ...
  'contextPanel.browser.tunnelFailedHint': '{url} は ShipChamber が動いているマシン上にあり、そこへの接続を開けませんでした。あなたのマシンの内容はここには表示されません。',
  ...
  'contextPanel.browser.devServers.remoteOnly': 'これらは ShipChamber を動かしているマシン上で動作しています。開くにはデスクトップアプリが必要です。',
  ...
  'contextPanel.browser.trustNotice': 'ここで開かれたページはShipChamberへの完全なアクセス権を持ちます — 検査とスクリーンショットに必要です。信頼できるサイトのみを開いてください: 悪意のあるページがデータを読み取ったりあなたの代わりに行動したりする可能性があります。',
  ...
  'filesView.editor.binaryFileDescription': 'このファイルはバイナリのため、ShipChamberでは編集できません。別のアプリで開くにはダウンロードしてください。',
  ...
  'directoryExplorerDialog.browse.permissionDenied': 'ShipChamber がこのフォルダにアクセスする必要があります。',
  ...
  'aboutDialog.shipChamberVersionLabel': 'ShipChamber バージョン {version}',
  ...
  'aboutDialog.diagnosticsDescription': 'ShipChamberの状態、OpenCodeの状態、ディレクトリ、プロジェクトが含まれます。',
  ...
  'helpDialog.description': 'これらのキーボードショートカットを使ってShipChamberを効率的に操作できます',
  ...
  'header.actions.openAppMenu': 'ShipChamberメニュー',
  'header.actions.openAppMenuAria': 'ShipChamberメニューを開く',
  ...
  'sessionAuth.error.networkDescription': 'UI セッションを確認できませんでした。ローカルネットワーク上の別のデバイスから ShipChamber を開く場合は、デスクトップアプリで Desktop Network Access を有効にし、設定に表示される LAN アドレスを使用してください。',
  ...
  'sessionAuth.locked.unlockTitle': 'ShipChamberのロックを解除',
  ...
  'desktopHostSwitcher.description': 'ローカルとリモートのShipChamberサーバーを切り替えます',
  ...
  'multiRun.window.description': 'ShipChamberマルチランウィンドウ。',
  ...
  'onboarding.chooser.title': 'ShipChamberへようこそ',
  ...
  'onboarding.localSetup.windows.stepSetBinaryPath': 'ShipChamberがOpenCodeを自動検出しない場合、以下のパスを手動で設定します。',
  'onboarding.localSetup.intro': 'OpenCodeはShipChamberの中核です — インストールして開始しましょう。',
  ...
  'onboarding.localSetup.helper.saveAndReload': 'ShipChamber設定に保存し、OpenCode設定を再読み込みします。',
  ...
  'onboarding.remoteConnection.description': '接続するShipChamberサーバーのアドレスを入力します。',
  ...
  'onboarding.remoteConnection.status.suggestionsWrongService': 'ヒント: URLがShipChamberサーバーを指しているか確認するか、サーバー管理者に問い合わせてください。',
  ...
  'onboarding.remoteConnection.probe.updateRecommendedMessage': 'このインスタンスは異なるバージョンのShipChamberを実行しています。接続は可能ですが、正常に動作しない場合は両方のアプリを更新してください。',
  'onboarding.remoteConnection.probe.incompatibleMessage': 'サーバーはShipChamberを実行していますが、このアプリバージョンと互換性がありません。サーバーのShipChamberを更新してから再試行してください。',
  'onboarding.remoteConnection.probe.wrongServiceMessage': 'サーバーは応答しましたが、ShipChamberを実行していません。アドレスがShipChamberサーバーを指していることを確認してください。',
  ...
  'onboarding.desktopRecovery.incompatibleServer.description': '「{host}」のサーバーはShipChamberを実行していません。アドレスがShipChamberサーバーを指していることを確認してください。',
  'onboarding.desktopRecovery.remoteIncompatible.title': 'サーバーの更新が必要',
  'onboarding.desktopRecovery.remoteIncompatible.description': '「{host}」のShipChamberサーバーはこのアプリバージョンと互換性がありません。サーバーのShipChamberを更新してから再試行してください。',
  ...
  'startup.initRecovery.description': 'ShipChamberが初期化を完了できませんでした。サーバーが実行中であることを確認してから再試行してください。',
  ...
  'updateDialog.header.updating': 'ShipChamberを更新中...',
  ...
  'updateDialog.error.takingLonger': '更新に予想以上に時間がかかっています。しばらく待ってから更新するか、次を実行: shipchamber update',
  'updateDialog.error.signatureRejected': 'ダウンロードした更新は拒否されました。コード署名がこのインストールと一致しません。通常は、実行中のコピーが公式の署名済みリリースからインストールされていないことを意味します。公式リリースから ShipChamber をインストールし直してから、もう一度更新してください。',
  'updateDialog.error.updaterDisabled': 'インストールに失敗したため、アップデーターが停止しました。ShipChamber を終了して開き直し、更新をやり直してください。',
  'updateDialog.error.restartFailed': '更新をインストールするための再起動に失敗しました。',
  'updateDialog.error.restartUnavailable': '更新のインストールには ShipChamber デスクトップアプリが必要です。',
  'mobileUpdate.toast.available.title': 'ShipChamberの更新があります',
  ...
  'opencodeUpdate.toast.upgrading.description': 'ShipChamberを開いたままにしてください。',
  ...
  'shipChamberLogo.aria.logo': 'ShipChamberロゴ',
