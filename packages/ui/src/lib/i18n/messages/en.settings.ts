...
export const settingsDict = {
  ...
  'settings.providers.page.openCodeGo.help': 'Copy the workspace ID from the dashboard URL and the auth cookie from your browser developer tools. ShipChamber never scans browser cookie storage.',
  ...
  'settings.window.description': 'ShipChamber settings window.',
  ...
  'settings.page.appearance.description': 'Customize how ShipChamber looks and feels.',
  ...
  'settings.shipchamber.tunnel.title': 'External Tunnel',
  'settings.shipchamber.tunnel.description': 'Configure secure remote access with quick links or your own managed remote Cloudflare tunnel.',
  'settings.shipchamber.tunnel.note.serverSideEnforced': 'Secure tunnel access is enforced server-side.',
  'settings.shipchamber.tunnel.note.connectLinksOneTime': 'Connect links are one-time and are revoked when tunnel stops or connect-link TTL expires.',
  'settings.shipchamber.tunnel.note.cloudflareConnectorTarget': 'Cloudflare connector target:',
  'settings.shipchamber.tunnel.note.cloudflareConnectorTargetUse': 'For Cloudflare connector target, use',
  'settings.shipchamber.tunnel.note.tokensSavedPerTunnel': 'Tokens are saved per tunnel and reused from disk.',
  'settings.shipchamber.tunnel.note.customConfigUsed': 'Custom config file will be used when starting the tunnel.',
  'settings.shipchamber.tunnel.note.defaultConfigUsed': 'When empty, cloudflared uses its default config (~/.cloudflared/config.yml).',
  'settings.shipchamber.tunnel.note.managedRemoteRequiresDomain': 'Managed remote tunnels require a purchased domain in your Cloudflare account.',
  'settings.shipchamber.tunnel.note.managedLocalUsesConfig': 'Managed local tunnels use your local cloudflared configuration file.',
  'settings.shipchamber.tunnel.note.startModeAndGenerateLink': 'Start a {mode} tunnel and generate a one-time connect link. Do not close the app while this tunnel is in use.',
  'settings.shipchamber.tunnel.note.scanQrToConnect': 'Scan with your phone to connect.',
  'settings.shipchamber.tunnel.section.redeemedAccessLinks': 'Redeemed access links',
  'settings.shipchamber.tunnel.section.savedManagedRemoteTunnels': 'Saved managed remote tunnels',
  'settings.shipchamber.tunnel.notAvailable.cloudflaredNotFound': 'cloudflared not found',
  'settings.shipchamber.tunnel.notAvailable.dependencyNotFound': '{dependency} was not found.',
  'settings.shipchamber.tunnel.notAvailable.installHint': 'Install it to enable remote tunnel access:',
  'settings.shipchamber.tunnel.field.provider': 'Provider',
  'settings.shipchamber.tunnel.field.providerPlaceholder': 'Select provider',
  'settings.shipchamber.tunnel.field.tunnelType': 'Tunnel type',
  'settings.shipchamber.tunnel.field.connectLinkTtl': 'Connect link TTL',
  ...
  'settings.shipchamber.tunnel.field.savedTokenAvailablePlaceholder': 'Saved token available (optional to replace)',
  'settings.shipchamber.tunnel.field.pasteTokenPlaceholder': 'Paste token for this tunnel',
  'settings.shipchamber.tunnel.field.newPresetNamePlaceholder': 'Tunnel name (e.g. Production)',
  'settings.shipchamber.tunnel.field.newPresetHostnamePlaceholder': 'Hostname (e.g. oc.example.com)',
  'settings.shipchamber.tunnel.field.newPresetTokenPlaceholder': 'Token',
  'settings.shipchamber.tunnel.field.managedRemoteTokenInfoAria': 'Managed remote tunnel token info',
  'settings.shipchamber.tunnel.field.configurationFile': 'Configuration file',
  'settings.shipchamber.tunnel.field.configurationFilePlaceholder': 'Using default cloudflared config',
  'settings.shipchamber.tunnel.field.managedRemoteTunnelToConnect': 'Managed remote tunnel to connect',
  'settings.shipchamber.tunnel.field.selectSavedTunnelPlaceholder': 'Select saved tunnel',
  'settings.shipchamber.tunnel.field.publicUrlHint': 'Public URL (not accessible without a token)',
  'settings.shipchamber.tunnel.field.connectLink': 'Connect link',
  'settings.shipchamber.tunnel.field.expires': 'Expires',
  'settings.shipchamber.tunnel.field.connectQrAlt': 'Tunnel connect QR code',
  'settings.shipchamber.tunnel.actions.removePresetAria': 'Remove {name}',
  'settings.shipchamber.tunnel.actions.saveToken': 'Save token',
  'settings.shipchamber.tunnel.actions.browseConfigFileAria': 'Browse config file',
  'settings.shipchamber.tunnel.actions.clearConfigFileAria': 'Clear config file',
  'settings.shipchamber.tunnel.actions.openManagedRemoteDocs': 'Check documentation on how to configure a managed remote tunnel',
  'settings.shipchamber.tunnel.actions.openManagedLocalDocs': 'Check documentation on managed local tunnel configuration',
  'settings.shipchamber.tunnel.actions.startTunnel': 'Start Tunnel',
  'settings.shipchamber.tunnel.actions.startingTunnel': 'Starting tunnel...',
  'settings.shipchamber.tunnel.actions.stopTunnel': 'Stop Tunnel',
  'settings.shipchamber.tunnel.actions.stopping': 'Stopping...',
  'settings.shipchamber.tunnel.actions.newConnectLink': 'New connect link',
  'settings.shipchamber.tunnel.actions.copied': 'Copied',
  'settings.shipchamber.tunnel.actions.retry': 'Retry',
  'settings.shipchamber.tunnel.option.moreProvidersSoon': 'More providers coming soon',
  'settings.shipchamber.tunnel.option.mode.quick.label': 'Quick',
  'settings.shipchamber.tunnel.option.mode.quick.tooltip': 'Quick Tunnel is best effort and uptime is not guaranteed.',
  'settings.shipchamber.tunnel.option.mode.managedRemote.label': 'Managed Remote',
  'settings.shipchamber.tunnel.option.mode.managedRemote.tooltip': 'Managed Remote uses your Cloudflare account and hostname for long-lived access.',
  'settings.shipchamber.tunnel.option.mode.managedLocal.label': 'Managed Local',
  'settings.shipchamber.tunnel.option.mode.managedLocal.tooltip': 'Managed Local uses your local cloudflared configuration file.',
  'settings.shipchamber.tunnel.warning.quickModeReliability': 'For more reliable long-lived access, switch to Managed Remote or Managed Local tunnel mode.',
  'settings.shipchamber.tunnel.warning.replacesActiveTunnel': 'Starting this tunnel replaces the active tunnel and revokes existing connect links and remote sessions.',
  ...
  'settings.shipchamber.tunnel.state.loading': 'Loading',
  'settings.shipchamber.tunnel.state.expired': 'Expired',
  'settings.shipchamber.tunnel.state.revoked': 'Revoked',
  'settings.shipchamber.tunnel.state.inactive': 'Inactive',
  'settings.shipchamber.tunnel.state.noExpiry': 'No expiry',
  'settings.shipchamber.tunnel.state.never': 'Never',
  'settings.shipchamber.tunnel.state.tunnelReady': 'Tunnel ready',
  'settings.shipchamber.tunnel.session.redeemedAt': 'Redeemed {time}',
  'settings.shipchamber.tunnel.session.expiresIn': 'Expires in {remaining}',
  'settings.shipchamber.tunnel.session.inactiveWithReason': 'Inactive ({reason})',
  'settings.shipchamber.tunnel.error.invalidConfigExtension': 'Config file must use .yml, .yaml, or .json extension.',
  'settings.shipchamber.tunnel.tooltip.tokensSavedPath': 'Tokens are saved in ~/.config/shipchamber/cloudflare-managed-remote-tunnels.json.',
  'settings.shipchamber.tunnel.empty.noManagedRemoteTunnels': 'No managed remote tunnels saved yet.',
  'settings.shipchamber.tunnel.toast.checkAvailabilityFailed': 'Failed to check tunnel availability',
  'settings.shipchamber.tunnel.toast.saveSettingsFailed': 'Failed to save tunnel settings',
  'settings.shipchamber.tunnel.toast.saveTtlFailed': 'Failed to save tunnel TTL settings',
  'settings.shipchamber.tunnel.toast.saveTokenFailed': 'Failed to save managed remote tunnel token',
  'settings.shipchamber.tunnel.toast.selectOrAddManagedRemoteFirst': 'Select or add a managed remote tunnel first',
  'settings.shipchamber.tunnel.toast.managedRemoteTokenRequiredBeforeStarting': 'Managed remote tunnel token is required before starting',
  'settings.shipchamber.tunnel.toast.addManagedRemoteTokenBeforeStarting': 'Add a managed remote tunnel token before starting',
  'settings.shipchamber.tunnel.toast.startFailed': 'Failed to start tunnel',
  'settings.shipchamber.tunnel.toast.startedButNoPublicUrl': 'Tunnel started but no public URL was returned',
  'settings.shipchamber.tunnel.toast.replacedTunnelSingleSingle': 'Replaced previous tunnel: revoked 1 link, invalidated 1 session.',
  'settings.shipchamber.tunnel.toast.replacedTunnelSingleManySessions': 'Replaced previous tunnel: revoked 1 link, invalidated {invalidatedSessionCount} sessions.',
  'settings.shipchamber.tunnel.toast.replacedTunnelManyLinksSingleSession': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated 1 session.',
  'settings.shipchamber.tunnel.toast.replacedTunnelManyMany': 'Replaced previous tunnel: revoked {revokedBootstrapCount} links, invalidated {invalidatedSessionCount} sessions.',
  'settings.shipchamber.tunnel.toast.linkReady': 'Tunnel link ready',
  'settings.shipchamber.tunnel.toast.stopped': 'Tunnel stopped',
  'settings.shipchamber.tunnel.toast.stopFailed': 'Failed to stop tunnel',
  'settings.shipchamber.tunnel.toast.connectLinkCopied': 'Connect link copied',
  'settings.shipchamber.tunnel.toast.copyUrlFailed': 'Failed to copy URL',
  'settings.shipchamber.tunnel.toast.saveSelectedManagedRemoteFailed': 'Failed to save selected managed remote tunnel',
  'settings.shipchamber.tunnel.toast.tunnelNameRequired': 'Tunnel name is required',
  'settings.shipchamber.tunnel.toast.managedRemoteHostnameRequired': 'Managed remote tunnel hostname is required',
  'settings.shipchamber.tunnel.toast.managedRemoteTokenRequired': 'Managed remote tunnel token is required',
  'settings.shipchamber.tunnel.toast.hostnameAlreadyExists': 'This hostname already exists',
  'settings.shipchamber.tunnel.toast.managedRemoteSaved': 'Managed remote tunnel saved',
  'settings.shipchamber.tunnel.toast.managedRemoteRemoved': 'Managed remote tunnel removed',
  ...
  'settings.remoteInstances.direct.title': 'Other ShipChamber servers',
  ...
  'settings.remoteInstances.direct.addDialog.description': 'Add another ShipChamber server by URL. Use this when the server is already running and you have a connection token.',
  ...
  'settings.remoteInstances.direct.import.description': 'Paste a connection link from another ShipChamber server.',
  ...
  'settings.remoteInstances.direct.error.invalidConnectLink': 'Invalid ShipChamber connection link.',
  ...
  'settings.remoteInstances.clientAuth.description': 'Create a secure link or token so ShipChamber Desktop can connect to this server.',
  ...
  'settings.remoteInstances.clientAuth.qrScanHint': 'Scan this with the ShipChamber app on your other device. It is single-use and expires.',
  ...
  'settings.remoteInstances.clientAuth.addDevice.transport.relayHint': 'Works at home and away. Away traffic goes through ShipChamber Private Relay — an end-to-end encrypted tunnel. No setup needed.',
  ...
  'settings.remoteInstances.relay.pair.qrDialogDescription': 'Scan this QR code with the ShipChamber app on your other device.',
  ...
  'settings.remoteInstances.page.field.modeHint': 'Choose whether ShipChamber should start the server for you, or connect to one that is already running.',
  ...
  'settings.remoteInstances.page.field.preferredRemotePortHint': 'Port ShipChamber uses on the remote machine. Leave empty to choose one automatically.',
  ...
  'settings.shipchamber.appLinks.title': 'Trusted app links',
  'settings.shipchamber.appLinks.info': 'Links listed here open without asking again on this device. Other app links always ask before opening.',
  'settings.shipchamber.appLinks.empty': 'No trusted app links on this device. Choose "Trust and open" when opening a link to add it here.',
  'settings.shipchamber.appLinks.removeAria': 'Remove trusted {scheme} links',
  ...
  'settings.shipchamber.about.title': 'About ShipChamber',
  'settings.shipchamber.about.field.version': 'Version',
  'settings.shipchamber.about.field.openCodeVersion': 'OpenCode version',
  'settings.shipchamber.about.field.instanceUrls': 'Instance URLs',
  'settings.shipchamber.about.field.applicationUrl': 'Application',
  'settings.shipchamber.about.field.tunnelUrl': 'Tunnel',
  'settings.shipchamber.about.state.checking': 'Checking...',
  'settings.shipchamber.about.state.upToDate': 'Up to date',
  'settings.shipchamber.about.state.unknown': 'unknown',
  'settings.shipchamber.about.actions.checkUpdates': 'Check updates',
  'settings.shipchamber.about.actions.update': 'Update',
  'settings.shipchamber.about.actions.updateToVersion': 'Update to {version}',
  'settings.shipchamber.about.actions.checkForUpdates': 'Check for updates',
  'settings.shipchamber.about.toast.latestVersion': 'You are on the latest version',
  ...
  'settings.skills.catalog.add.descriptionPrefix': 'Add a Git repository as a new catalog source. ShipChamber will scan it for folders containing',
  ...
  'settings.shipchamber.passkeys.field.currentDevice': 'Current device',
  'settings.shipchamber.passkeys.actions.add': 'Add passkey',
  'settings.shipchamber.passkeys.actions.cancelSetup': 'Cancel passkey setup',
  'settings.shipchamber.passkeys.actions.signOutEverywhere': 'Sign out everywhere',
  'settings.shipchamber.passkeys.actions.signingOut': 'Signing out…',
  'settings.shipchamber.passkeys.actions.removing': 'Removing…',
  'settings.shipchamber.passkeys.state.uiPasswordRequired': 'Passkeys are available only when the UI password lock is enabled.',
  'settings.shipchamber.passkeys.state.loading': 'Loading passkeys…',
  'settings.shipchamber.passkeys.state.noneSaved': 'No passkeys saved for this host yet.',
  'settings.shipchamber.passkeys.item.lastUsed': 'Last used {time}',
  'settings.shipchamber.passkeys.item.added': 'Added {time}',
  'settings.shipchamber.passkeys.time.neverUsed': 'Never used',
  'settings.shipchamber.passkeys.toast.loadFailed': 'Could not load passkeys.',
  'settings.shipchamber.passkeys.toast.enableUiPasswordFirst': 'Enable the UI password lock before adding passkeys.',
  'settings.shipchamber.passkeys.toast.added': 'Passkey added',
  'settings.shipchamber.passkeys.toast.setupCanceled': 'Passkey setup canceled',
  'settings.shipchamber.passkeys.toast.addFailed': 'Could not add passkey.',
  'settings.shipchamber.passkeys.toast.removed': 'Passkey removed',
  'settings.shipchamber.passkeys.toast.removeFailed': 'Could not remove passkey.',
  'settings.shipchamber.passkeys.toast.clearAuthFailed': 'Could not clear saved authentication.',
  'settings.shipchamber.sessionRetention.title': 'Session Retention',
  'settings.shipchamber.sessionRetention.tooltip': 'Automatically archive or delete inactive sessions based on last activity. Keeps the 5 most recent sessions.',
  'settings.shipchamber.sessionRetention.field.enableAutoCleanupAria': 'Enable auto-cleanup',
  'settings.shipchamber.sessionRetention.field.enableAutoCleanup': 'Enable Auto-Cleanup',
  'settings.shipchamber.sessionRetention.field.retentionPeriod': 'Retention Period',
  'settings.shipchamber.sessionRetention.field.retentionPeriodAria': 'Retention period in days',
  'settings.shipchamber.sessionRetention.field.days': 'days',
  'settings.shipchamber.sessionRetention.field.whenSessionsExpire': 'When sessions expire',
  'settings.shipchamber.sessionRetention.actions.resetRetentionAria': 'Reset retention period',
  'settings.shipchamber.sessionRetention.actions.runCleanupNow': 'Run cleanup now',
  'settings.shipchamber.sessionRetention.actions.cleaningUp': 'Cleaning up...',
  'settings.shipchamber.sessionRetention.action.archive': 'Archive',
  'settings.shipchamber.sessionRetention.action.delete': 'Delete',
  'settings.shipchamber.sessionRetention.manualCleanup.title': 'Manual Cleanup',
  'settings.shipchamber.sessionRetention.manualCleanup.eligibleArchiveNow': 'Eligible for archiving right now: {count}',
  'settings.shipchamber.sessionRetention.manualCleanup.eligibleDeleteNow': 'Eligible for deletion right now: {count}',
  'settings.shipchamber.sessionRetention.toast.noneEligibleArchive': 'No sessions eligible for archiving',
  'settings.shipchamber.sessionRetention.toast.noneEligibleDelete': 'No sessions eligible for deletion',
  'settings.shipchamber.sessionRetention.toast.archivedCount': 'Archived {count} session(s)',
  'settings.shipchamber.sessionRetention.toast.deletedCount': 'Deleted {count} session(s)',
  'settings.shipchamber.sessionRetention.toast.failedArchiveCount': 'Failed to archive {count} session(s)',
  'settings.shipchamber.sessionRetention.toast.failedDeleteCount': 'Failed to delete {count} session(s)',
  'settings.shipchamber.desktopNetwork.title': 'Desktop Network Access',
  'settings.shipchamber.desktopNetwork.field.windowControlsPosition': 'Window controls position',
  'settings.shipchamber.desktopNetwork.field.windowControlsPositionDescription': 'Choose where minimize, maximize, and close buttons appear. Defaults to the right.',
  'settings.shipchamber.desktopNetwork.field.windowControlsPositionAria': 'Window controls position',
  'settings.shipchamber.desktopNetwork.option.windowControlsLeft': 'Left',
  'settings.shipchamber.desktopNetwork.option.windowControlsRight': 'Right',
  'settings.shipchamber.desktopNetwork.field.windowControls': 'Window controls',
  'settings.shipchamber.desktopNetwork.field.windowControlsStyle': 'Style',
  'settings.shipchamber.desktopNetwork.field.windowControlsStyleAria': 'Window controls style',
  'settings.shipchamber.desktopNetwork.option.windowControlsClassic': 'Classic',
  'settings.shipchamber.desktopNetwork.option.windowControlsTrafficLights': 'Traffic lights',
  'settings.shipchamber.desktopNetwork.field.launchAtLoginAria': 'Start ShipChamber at login',
  'settings.shipchamber.desktopNetwork.field.launchAtLogin': 'Start ShipChamber when you log in',
  'settings.shipchamber.desktopNetwork.field.launchAtLoginDescription': 'Starts the app in the background without opening a window. Use the desktop status icon to open it.',
  'settings.shipchamber.desktopNetwork.field.macMenuBarAria': 'Show ShipChamber in the macOS menu bar',
  'settings.shipchamber.desktopNetwork.field.macMenuBar': 'Show ShipChamber in the menu bar',
  'settings.shipchamber.desktopNetwork.field.macMenuBarDescription': 'Requires an app restart. When off, ShipChamber does not create the menu bar item or run its session, approval, and usage updates.',
  'settings.shipchamber.desktopNetwork.field.minimizeToTrayAria': 'Close ShipChamber to the system tray',
  'settings.shipchamber.desktopNetwork.field.minimizeToTray': 'Close to the system tray',
  'settings.shipchamber.desktopNetwork.field.minimizeToTrayDescription': 'Keeps ShipChamber running in the system tray when the main window is closed. Minimizing still leaves the window in the taskbar.',
  'settings.shipchamber.desktopNetwork.field.keepAwakeAria': 'Keep computer awake while ShipChamber is running',
  'settings.shipchamber.desktopNetwork.field.keepAwake': 'Keep computer awake while ShipChamber is running',
  'settings.shipchamber.desktopNetwork.field.keepAwakeDescription': 'Prevents system sleep so phones can keep reaching this app. The screen can still turn off.',
  'settings.shipchamber.desktopNetwork.field.allowLanAccessAria': 'Allow LAN access to desktop sidecar',
  'settings.shipchamber.desktopNetwork.field.allowLanAccess': 'Let other devices on your local network open this app',
  'settings.shipchamber.desktopNetwork.field.allowLanAccessDescription': 'Restarts the app so phones, tablets, and other computers on your Wi-Fi can open it.',
  'settings.shipchamber.desktopNetwork.field.warning': 'Warning: while enabled, the app is reachable by anyone on the same local network.',
  'settings.shipchamber.desktopNetwork.field.passwordRequiredWarning': 'LAN access requires a Desktop UI Password. Until one is set, the desktop app starts local-only.',
  'settings.shipchamber.desktopPassword.actions.showPassword': 'Show password',
  'settings.shipchamber.desktopPassword.actions.hidePassword': 'Hide password',
  'settings.shipchamber.desktopPassword.field.password': 'Desktop UI Password',
  'settings.shipchamber.desktopPassword.field.passwordPlaceholder': 'No password required',
  'settings.shipchamber.desktopPassword.field.passwordDescription': 'ShipChamber asks after restart, then when the login session expires: after 12 hours, or 7 days with Trust this device. Leave empty to disable login.',
  'settings.shipchamber.desktopNetwork.hint.openAfterRestart': 'After restart, open from another device: ',
  'settings.shipchamber.desktopNetwork.hint.openNow': 'Open from another device: ',
  'settings.shipchamber.desktopNetwork.actions.saveAndRestart': 'Save + Restart',
  'settings.shipchamber.desktopNetwork.error.loadFailed': 'Failed to load desktop settings',
  'settings.shipchamber.desktopNetwork.error.saveFailed': 'Failed to save desktop settings',
  'settings.shipchamber.desktopNetwork.error.savedRestartFailed': 'Saved, but failed to restart app',
  'settings.shipchamber.desktopNetwork.error.launchAtLoginUnsupported': 'Launch at login is not supported on this system',
  'settings.shipchamber.desktopNetwork.error.launchAtLoginSaveFailed': 'Failed to update launch at login setting',
  'settings.shipchamber.desktopNetwork.error.minimizeToTrayUnsupported': 'System tray background mode is not supported on this system',
  'settings.shipchamber.desktopNetwork.error.minimizeToTraySaveFailed': 'Failed to update system tray setting',
  'settings.shipchamber.desktopNetwork.error.keepAwakeUnsupported': 'Preventing sleep is not supported on this system',
  'settings.shipchamber.desktopNetwork.error.keepAwakeSaveFailed': 'Failed to update keep awake setting',
  'settings.shipchamber.opencodeCli.title': 'OpenCode CLI',
  'settings.shipchamber.tools.title': 'ShipChamber Tools',
  'settings.shipchamber.tools.field.agentControlTool': 'Agent control tool',
  'settings.shipchamber.tools.field.agentControlToolAria': 'Enable the agent control tool',
  'settings.shipchamber.tools.field.agentControlToolInfo': 'Let agents orchestrate your work from chat: spin up sessions and worktrees, delegate prompts to other agents, and manage scheduled tasks. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.shipchamber.tools.field.agentWebTool': 'ShipChamber Web tool',
  'settings.shipchamber.tools.field.agentWebToolAria': 'Enable the ShipChamber Web tool',
  'settings.shipchamber.tools.field.agentWebToolInfo': 'Let agents look at and interact with the page in ShipChamber\'s browser panel: open a URL, read the page, click, type, scroll, and switch between mobile and desktop layouts. Adds a small tool description to each session. Applies after OpenCode restarts.',
  'settings.shipchamber.tools.field.agentMemoryTool': 'Agent memory tool',
  'settings.shipchamber.tools.field.agentMemoryToolAria': 'Agent memory tool',
  ...
  'settings.shipchamber.opencodeCli.tooltipPrefix': 'Optional absolute path to the',
  'settings.shipchamber.opencodeCli.tooltipSuffix': 'binary.',
  'settings.shipchamber.opencodeCli.field.binaryPath': 'OpenCode Binary Path',
  'settings.shipchamber.opencodeCli.field.binaryPathPlaceholder': '/Users/you/.bun/bin/opencode',
  'settings.shipchamber.opencodeCli.field.showUpdateNotifications': 'Show OpenCode update notifications',
  'settings.shipchamber.opencodeCli.field.showUpdateNotificationsAria': 'Show OpenCode update notifications',
  'settings.shipchamber.opencodeCli.actions.browseAria': 'Browse for OpenCode binary path',
  'settings.shipchamber.opencodeCli.actions.browse': 'Browse',
  'settings.shipchamber.opencodeCli.actions.saveAndReload': 'Save + Reload',
  'settings.shipchamber.opencodeCli.actions.restartingOpenCode': 'Restarting OpenCode…',
  'settings.shipchamber.opencodeCli.dialog.selectBinaryTitle': 'Select opencode binary',
  'settings.shipchamber.opencodeCli.tipPrefix': 'Tip: you can also use',
  'settings.shipchamber.opencodeCli.tipMiddle': 'env var, but this setting persists in',
  ...
  'settings.shipchamber.keyboardShortcuts.title': 'Keyboard Shortcuts',
  'settings.shipchamber.keyboardShortcuts.actions.resetAll': 'Reset All',
  'settings.shipchamber.keyboardShortcuts.actions.overwrite': 'Overwrite',
  'settings.shipchamber.keyboardShortcuts.tooltip': 'Capture a new key combo, save it, and bindings will update immediately.',
  'settings.shipchamber.keyboardShortcuts.overwritePrompt': 'This combo is already used by another shortcut. Overwrite and clear that other mapping?',
  'settings.shipchamber.keyboardShortcuts.field.pressKeys': 'Press keys...',
  'settings.shipchamber.keyboardShortcuts.error.captureFirst': 'Capture a shortcut first.',
    'settings.shipchamber.keyboardShortcuts.warning.riskyBrowserShortcut': 'This shortcut can conflict with browser defaults. You can still save it.',
  'settings.shipchamber.keyboardShortcuts.action.open_go_to_line.label': 'Go to line (files editor)',
  'settings.shipchamber.keyboardShortcuts.action.open_command_palette.label': 'Open command palette',
  'settings.shipchamber.keyboardShortcuts.action.focus_input.label': 'Focus input',
  'settings.shipchamber.keyboardShortcuts.action.open_settings.label': 'Open settings',
  'settings.shipchamber.keyboardShortcuts.action.toggle_terminal.label': 'Toggle terminal dock',
  'settings.shipchamber.keyboardShortcuts.action.toggle_terminal_expanded.label': 'Toggle terminal expanded',
  'settings.shipchamber.keyboardShortcuts.action.add_selection_to_chat.label': 'Add selection to chat',
  'settings.shipchamber.keyboardShortcuts.action.toggle_sidebar.label': 'Toggle sidebar',
    'settings.shipchamber.keyboardShortcuts.action.switch_session_tab.label': 'Switch session tab',
  'settings.shipchamber.keyboardShortcuts.action.switch_session_tab.suffix': ' + 1…9',
  'settings.shipchamber.keyboardShortcuts.action.switch_context_surface.label': 'Switch context panel surface',
  'settings.shipchamber.keyboardShortcuts.action.switch_context_surface.suffix': ' + 1…0',
  'settings.shipchamber.keyboardShortcuts.action.new_chat.label': 'New session',
  'settings.shipchamber.keyboardShortcuts.action.switch_session_previous.label': 'Previous session',
  'settings.shipchamber.keyboardShortcuts.action.switch_session_next.label': 'Next session',
  'settings.shipchamber.keyboardShortcuts.action.rename_current_session.label': 'Rename current session',
  'settings.shipchamber.keyboardShortcuts.action.toggle_permission_auto_accept.label': 'Toggle permission auto-accept',
  'settings.shipchamber.keyboardShortcuts.action.close_session_tab.label': 'Close session tab',
  'settings.shipchamber.keyboardShortcuts.action.new_chat_worktree.label': 'New worktree draft',
  'settings.shipchamber.keyboardShortcuts.action.new_mini_chat.label': 'New Mini Chat window',
  'settings.shipchamber.keyboardShortcuts.action.open_help.label': 'Open keyboard shortcuts',
  'settings.shipchamber.keyboardShortcuts.action.toggle_services_menu.label': 'Toggle services menu',
  'settings.shipchamber.keyboardShortcuts.action.cycle_theme.label': 'Cycle theme',
  'settings.shipchamber.keyboardShortcuts.action.cycle_agent.label': 'Cycle agent',
  'settings.shipchamber.keyboardShortcuts.action.cycle_favorite_model_forward.label': 'Cycle favorite model forward',
  'settings.shipchamber.keyboardShortcuts.action.cycle_favorite_model_backward.label': 'Cycle favorite model backward',
  'settings.shipchamber.keyboardShortcuts.action.open_model_selector.label': 'Open model selector',
  'settings.shipchamber.keyboardShortcuts.action.expand_input.label': 'Expand input',
  'settings.shipchamber.keyboardShortcuts.action.open_timeline_dialog.label': 'Open conversation timeline',
  'settings.shipchamber.keyboardShortcuts.action.toggle_prompt_navigator.label': 'Toggle prompt navigator',
  'settings.shipchamber.keyboardShortcuts.warning.contextualPrefix': 'This sequence shares a contextual prefix with {action}. That action takes priority while its context is active.',
  'settings.shipchamber.keyboardShortcuts.category.session': 'Session Controls',
  'settings.shipchamber.keyboardShortcuts.category.models': 'Models & Agents',
  'settings.shipchamber.keyboardShortcuts.category.panels': 'Panels & Tools',
  ...
  'settings.shipchamber.keyboardShortcuts.actions.edit': 'Edit',
  'settings.shipchamber.keyboardShortcuts.actions.confirm': 'Confirm',
  'settings.shipchamber.keyboardShortcuts.dialog.title': 'Edit {action}',
  'settings.shipchamber.keyboardShortcuts.dialog.instructions': 'Press up to two key combinations, with at most three keys each. After the first, wait up to 3 seconds for a second combination. Use Confirm to apply or Cancel to discard. Backspace removes the last one.',
  'settings.shipchamber.keyboardShortcuts.dialog.firstChord': 'First combination',
  'settings.shipchamber.keyboardShortcuts.dialog.secondChord': 'Second combination',
  'settings.shipchamber.keyboardShortcuts.dialog.recording': 'Press keys…',
  'settings.shipchamber.keyboardShortcuts.unassigned': 'Unassigned',
  'settings.shipchamber.keyboardShortcuts.error.prefixConflict': 'This conflicts with the sequence used by {action}. Choose a different combination.',
  'settings.shipchamber.keyboardShortcuts.error.exactConflict': 'This combination is already used by {action}.',
  'settings.shipchamber.keyboardShortcuts.error.internalConflict': 'This combination conflicts with a built-in shortcut, which cannot be replaced.',
  'settings.shipchamber.keyboardShortcuts.action.open_draft_project_picker.label': 'Open draft project picker',
  'settings.shipchamber.keyboardShortcuts.action.open_draft_worktree_picker.label': 'Open draft worktree picker',
  'settings.shipchamber.keyboardShortcuts.action.open_session_list.label': 'Open recent sessions',
  'settings.shipchamber.keyboardShortcuts.action.toggle_dictation.label': 'Voice input',
  ...
  'settings.remoteInstances.page.description': 'Connect to another machine over SSH and open ShipChamber there.',
  ...
  'settings.remoteInstances.page.section.remoteServer': 'ShipChamber on the remote machine',
  'settings.remoteInstances.page.section.remoteServerDescription': 'Choose how ShipChamber should run after SSH connects.',
  'settings.remoteInstances.page.section.mainTunnel': 'Access from this computer',
  'settings.remoteInstances.page.section.mainTunnelDescription': 'ShipChamber runs on the remote machine. These settings only control the address on this computer that forwards to it through the SSH tunnel.',
  'settings.remoteInstances.page.section.authentication': 'Authentication',
  'settings.remoteInstances.page.section.authenticationDescription': 'Optional credentials for SSH and the remote ShipChamber UI.',
  ...
  'settings.remoteInstances.page.field.installMethodHint': 'How ShipChamber should be placed on the remote machine when this app starts it for you.',
  ...
  'settings.remoteInstances.page.validation.externalPortRequired': 'Set a remote port first. In "Already running" mode ShipChamber needs to know which port the server listens on.',
  ...
  'settings.remoteInstances.page.field.remoteLanAccessHint': 'Also let other devices on the remote machine’s network open this ShipChamber directly, without the SSH tunnel. A UI password is required.',
  'settings.remoteInstances.page.field.remoteLanAccessWarning': 'Anyone on that network can reach the remote ShipChamber. It is protected only by the UI password below.',
  'settings.remoteInstances.page.validation.remoteLanNeedsPassword': 'Set a UI password first. Publishing the remote ShipChamber to its network without one would leave it open to every device there.',
  ...
  'settings.remoteInstances.page.field.uiPasswordHintManaged': 'Password to protect the remote ShipChamber UI. ShipChamber sets it on the server it starts for you.',
  'settings.remoteInstances.page.field.uiPasswordHintExternal': 'Password of the ShipChamber server already running on the remote machine, used to sign in to it.',
  ...
  'settings.remoteInstances.page.phase.installingShipChamber': 'Installing ShipChamber',
  'settings.remoteInstances.page.phase.updatingShipChamber': 'Updating ShipChamber',
  ...
  'settings.shipchamber.worktrees.state.selectProject': 'Select a project to manage worktrees.',
  'settings.shipchamber.worktrees.state.gitOnly': 'Worktree settings are only available for Git repositories.',
  'settings.shipchamber.worktrees.setup.title': 'Setup commands',
  'settings.shipchamber.worktrees.setup.tooltipPrefix': 'Run automatically inside the new worktree directory when a worktree is created. Use',
  'settings.shipchamber.worktrees.setup.tooltipSuffix': 'for the project root.',
  'settings.shipchamber.worktrees.setup.loading': 'Loading...',
  'settings.shipchamber.worktrees.setup.commandPlaceholder': 'e.g., bun install',
  'settings.shipchamber.worktrees.setup.removeCommandAria': 'Remove command',
  'settings.shipchamber.worktrees.setup.addCommand': 'Add command',
  'settings.shipchamber.worktrees.setup.waitForCommands': 'Wait for setup commands before creating or sending a session',
  'settings.shipchamber.worktrees.setup.waitForCommandsAria': 'Wait for Worktree setup commands before creating or sending a session',
  'settings.shipchamber.worktrees.setup.toast.saveFailed': 'Failed to save worktree setup commands',
  'settings.shipchamber.worktrees.list.title': 'Existing worktrees',
  'settings.shipchamber.worktrees.list.tooltip': 'Deleting a worktree also removes its linked sessions.',
  'settings.shipchamber.worktrees.list.loading': 'Loading worktrees...',
  'settings.shipchamber.worktrees.list.empty': 'No worktrees found for this project',
  'settings.shipchamber.worktrees.list.detachedHead': 'Detached HEAD',
  'settings.shipchamber.worktrees.list.deleteWorktreeAria': 'Delete worktree {name}',
  ...
  'settings.providers.page.custom.field.apiKey.info': 'Stored in OpenCode auth, not by ShipChamber. Use {env:VAR_NAME} to read a key from the environment instead.',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'Keys are sent directly to OpenCode and never stored by ShipChamber.',
  ...
  'settings.shipchamber.defaults.title': 'Session Defaults',
  'settings.shipchamber.defaults.summaryPrefix': 'New sessions will start with:',
  'settings.shipchamber.defaults.summaryOpenCodeDefault': 'OpenCode agent default',
  'settings.shipchamber.defaults.field.defaultModel': 'Default Model',
  'settings.shipchamber.defaults.field.defaultThinking': 'Default Thinking',
  'settings.shipchamber.defaults.field.thinkingPlaceholder': 'Thinking',
  'settings.shipchamber.defaults.field.defaultAgent': 'Default Agent',
  'settings.shipchamber.defaults.field.showDeletionDialogAria': 'Show deletion dialog',
  'settings.shipchamber.defaults.field.showDeletionDialog': 'Show Deletion Dialog',
  'settings.shipchamber.defaults.smallModel.title': 'Small Model',
  'settings.shipchamber.defaults.smallModel.description': 'A cheap model for quick utility tasks like short recaps and summaries.',
  'settings.shipchamber.defaults.smallModel.useDefault': 'Use default small model',
  'settings.shipchamber.defaults.smallModel.useDefaultAria': 'Use default small model',
  'settings.shipchamber.defaults.smallModel.overrideModel': 'Override model',
  'settings.shipchamber.defaults.walkthroughModel.title': 'Changes Walkthrough Model',
  ...
  'settings.shipchamber.defaults.walkthroughModel.overrideModel': 'Walkthrough model',
  'settings.shipchamber.defaults.walkthroughModel.usesSmallModel': 'Small model',
  'settings.shipchamber.defaults.field.openFilesPreviewAria': 'Open previewable files in preview mode',
  'settings.shipchamber.defaults.field.openFilesPreview': 'Open previewable files in preview mode',
  'settings.shipchamber.defaults.option.default': 'Default',
  'settings.shipchamber.defaults.option.defaultLowercase': 'default',
  'settings.shipchamber.git.title': 'Git Preferences',
  'settings.shipchamber.git.changesViewTitle': 'Changes View',
  'settings.shipchamber.git.changesViewAria': 'Git changes view mode',
  'settings.shipchamber.git.option.flatList': 'Flat List',
  'settings.shipchamber.git.option.treeView': 'Tree View',
  'settings.shipchamber.git.optionAria': 'Git changes view mode: {option}',
  'settings.shipchamber.git.enableGitmojiAria': 'Enable Gitmoji picker',
  'settings.shipchamber.git.enableGitmoji': 'Enable Gitmoji Picker',
  'settings.shipchamber.git.showGitignoredAria': 'Display gitignored files',
  'settings.shipchamber.git.showGitignored': 'Display Gitignored Files',
  ...
  'settings.github.page.flow.title': 'Authorize ShipChamber',
  ...
  'settings.github.page.ghCli.fallbackDescription': 'Available as fallback if ShipChamber auth is removed',
  ...
  'settings.notifications.page.testNotification.body': 'This is a test notification from ShipChamber.',
  ...
  'settings.voice.page.tooltip.sttLocal': 'On-device transcription on the ShipChamber server. Models download automatically; no API key needed.',
  'settings.voice.page.tooltip.localTts': 'On-device synthesis on the ShipChamber server (Kokoro for English; models for other languages download on first use). No API key needed.',
  ...
  'settings.shipchamber.visual.section.colorMode': 'Color Mode',
  'settings.shipchamber.visual.section.colorModeAndTheme': 'Color mode & Theme',
  'settings.shipchamber.visual.section.localization': 'Localization',
  'settings.shipchamber.visual.section.spacingAndLayout': 'Spacing & Layout',
  'settings.shipchamber.visual.section.densityAndType': 'Density & type',
  'settings.shipchamber.visual.section.appInstall': 'App install',
  'settings.shipchamber.visual.section.navigation': 'Navigation',
  'settings.shipchamber.visual.section.chatRenderMode': 'Chat Render Mode',
  'settings.shipchamber.visual.section.chatRenderModeAria': 'Chat render mode',
  'settings.shipchamber.visual.section.chatDisplay': 'Display',
  'settings.shipchamber.visual.section.chatMessageOptions': 'Message options',
  'settings.shipchamber.visual.section.chatFeatures': 'Features',
  'settings.shipchamber.visual.section.messageStreamTransport': 'Message Stream Transport',
  'settings.shipchamber.visual.section.activityDefault': 'Activity Default',
  'settings.shipchamber.visual.section.activityDefaultAria': 'Activity default mode',
  'settings.shipchamber.visual.section.showToolsOpenedByDefault': 'Show tools opened by default',
  'settings.shipchamber.visual.section.sessionAssistance': 'Session Assistance',
  'settings.shipchamber.visual.section.reasoning': 'Reasoning',
  'settings.shipchamber.visual.section.streaming': 'Streaming',
  'settings.shipchamber.visual.field.streamingAutoFollow': 'Follow new content while streaming',
  'settings.shipchamber.visual.field.streamingAutoFollowAria': 'Automatically follow new content while a response streams',
  'settings.shipchamber.visual.field.streamingAutoFollowInfo': 'While a reply streams in, the view keeps gliding to the newest content. Turn this off to keep the view still and scroll manually; sending a message while scrolled up then also leaves the view where it is.',
  'settings.shipchamber.visual.section.messageAppearance': 'Message Appearance',
  'settings.shipchamber.visual.section.toolsAndFiles': 'Tools & Files',
  'settings.shipchamber.visual.section.composer': 'Composer',
  'settings.shipchamber.visual.section.userMessageRendering': 'User Message Rendering',
  'settings.shipchamber.visual.section.userMessageRenderingAria': 'User message rendering mode',
  'settings.shipchamber.visual.section.mermaidRendering': 'Mermaid Rendering',
  'settings.shipchamber.visual.section.mermaidRenderingAria': 'Mermaid rendering mode',
  'settings.shipchamber.visual.section.diffLayout': 'Diff Layout',
  'settings.shipchamber.visual.section.diffLayoutAria': 'Diff layout',
  'settings.shipchamber.visual.section.privacy': 'Privacy',
  'settings.shipchamber.visual.field.lightTheme': 'Light Theme',
  'settings.shipchamber.visual.field.darkTheme': 'Dark Theme',
  'settings.shipchamber.visual.field.selectLightThemeAria': 'Select light theme',
  'settings.shipchamber.visual.field.selectDarkThemeAria': 'Select dark theme',
  'settings.shipchamber.visual.field.selectThemePlaceholder': 'Select theme',
  'settings.shipchamber.visual.field.timeFormat': 'Time Format',
  'settings.shipchamber.visual.field.weekStartsOn': 'Week Starts On',
  'settings.shipchamber.visual.field.selectTimeFormatAria': 'Select time format',
  'settings.shipchamber.visual.field.selectWeekStartAria': 'Select week start',
  'settings.shipchamber.visual.actions.reloadThemes': 'Reload themes',
  'settings.shipchamber.visual.actions.reloadingThemes': 'Reloading themes...',
  'settings.shipchamber.visual.field.dockBadge': 'Dock badge',
  'settings.shipchamber.visual.field.dockBadgeHint': 'Show a count of chats with unseen activity on the macOS dock icon.',
  'settings.shipchamber.visual.actions.saveAndRestart': 'Save & restart',
  'settings.shipchamber.visual.actions.restarting': 'Restarting…',
  'settings.shipchamber.visual.field.themeImportInfoAria': 'Theme import info',
  'settings.shipchamber.visual.field.themeImportInfoTooltip': 'Import custom themes from ~/.config/shipchamber/themes/',
  'settings.shipchamber.visual.field.installAppName': 'Install App Name',
  'settings.shipchamber.visual.field.installAppNameHint': 'Used by PWA installation process.',
  'settings.shipchamber.visual.field.pwaInstallAppNameAria': 'PWA install app name',
  'settings.shipchamber.visual.actions.resetInstallAppNameAria': 'Reset install app name',
  'settings.shipchamber.visual.field.installOrientation': 'Install Orientation',
  'settings.shipchamber.visual.field.installOrientationHint': 'Used by the installed web app. Reinstall the PWA after changing this.',
  'settings.shipchamber.visual.field.pwaInstallOrientationAria': 'PWA install orientation',
  'settings.shipchamber.visual.field.selectOrientationPlaceholder': 'Select orientation',
  'settings.shipchamber.visual.actions.resetInstallOrientationAria': 'Reset install orientation',
  'settings.shipchamber.visual.field.mobileKeyboardMode': 'Mobile Keyboard Behavior',
  'settings.shipchamber.visual.field.mobileKeyboardModeHint': 'Default browser behavior is safest. Resize content asks supported browsers to shrink the app when the on-screen keyboard opens.',
  'settings.shipchamber.visual.field.mobileKeyboardModeAria': 'Mobile keyboard behavior',
  'settings.shipchamber.visual.field.selectMobileKeyboardModePlaceholder': 'Select keyboard behavior',
  'settings.shipchamber.visual.actions.resetMobileKeyboardModeAria': 'Reset mobile keyboard behavior',
  'settings.shipchamber.visual.field.interfaceFontSize': 'Interface Font Size',
  'settings.shipchamber.visual.field.interfaceFont': 'Interface Font',
  'settings.shipchamber.visual.field.selectInterfaceFontAria': 'Select interface font',
  'settings.shipchamber.visual.actions.resetInterfaceFontAria': 'Reset interface font',
  'settings.shipchamber.visual.field.fontSizePercentageAria': 'Font size percentage',
  'settings.shipchamber.visual.actions.resetFontSizeAria': 'Reset font size',
  'settings.shipchamber.visual.field.terminalFontSize': 'Terminal Font Size',
  'settings.shipchamber.visual.field.terminalShell': 'Terminal Shell',
  'settings.shipchamber.visual.field.terminalShellAria': 'Select terminal shell',
  'settings.shipchamber.visual.field.terminalShellHint': 'Restart the terminal to apply this change to the current session.',
  'settings.shipchamber.visual.field.terminalLoginShell': 'Start as login shell',
  'settings.shipchamber.visual.option.terminalShell.auto': 'Auto',
  'settings.shipchamber.visual.field.editorFontSize': 'Editor Font Size',
  'settings.shipchamber.visual.field.codeFont': 'Code Font',
  'settings.shipchamber.visual.field.selectCodeFontAria': 'Select code font',
  'settings.shipchamber.visual.actions.resetCodeFontAria': 'Reset code font',
  'settings.shipchamber.visual.actions.resetTerminalFontSizeAria': 'Reset terminal font size',
  'settings.shipchamber.visual.actions.resetEditorFontSizeAria': 'Reset editor font size',
  'settings.shipchamber.visual.field.spacingDensity': 'Spacing Density',
  'settings.shipchamber.visual.actions.resetSpacingAria': 'Reset spacing',
  'settings.shipchamber.visual.field.inputBarOffset': 'Input Bar Offset',
  'settings.shipchamber.visual.field.inputBarOffsetTooltip': 'Raise input bar to avoid OS-level screen obstructions like home bars.',
  'settings.shipchamber.visual.actions.resetInputBarOffsetAria': 'Reset input bar offset',
  'settings.shipchamber.visual.field.terminalQuickKeysAria': 'Terminal quick keys',
  'settings.shipchamber.visual.field.terminalQuickKeys': 'Terminal Quick Keys',
  'settings.shipchamber.visual.field.sessionTabsGroup': 'Session tabs',
  'settings.shipchamber.visual.field.sessionTabs': 'Show sessions as tabs in the header',
  'settings.shipchamber.visual.field.sessionTabsAria': 'Toggle session tabs in the header',
  'settings.shipchamber.visual.field.sessionTabsInfo': 'Sessions you open line up as tabs in the header. Turning this off restores the plain session title.',
  'settings.shipchamber.visual.field.terminalQuickKeysTooltip': 'Show Esc, Ctrl, Arrows in terminal view',
  'settings.shipchamber.visual.field.fileEditorKeymap': 'File editor keymap',
  'settings.shipchamber.visual.option.fileEditorKeymap.default': 'Default',
  'settings.shipchamber.visual.option.fileEditorKeymap.vim': 'Vim',
  'settings.shipchamber.visual.field.activityDefaultModeAria': 'Activity default mode: {option}',
  'settings.shipchamber.visual.field.showExpandedBashToolsAria': 'Show expanded bash tools',
  'settings.shipchamber.visual.field.showExpandedEditToolsAria': 'Show expanded edit tools',
  'settings.shipchamber.visual.field.bash': 'Bash',
  'settings.shipchamber.visual.field.editTools': 'Edit tools',
  'settings.shipchamber.visual.field.userMessageRenderingAria': 'User message rendering: {option}',
  ...
  'settings.shipchamber.visual.field.sessionRecap': 'Generate Session Recap',
  'settings.shipchamber.visual.field.sessionRecapAria': 'Generate a recap after the agent finishes',
  'settings.shipchamber.visual.field.sessionSuggestion': 'Generate Next User Message Suggestion',
  'settings.shipchamber.visual.field.sessionSuggestionAria': 'Generate a suggested next user message after the agent finishes',
  'settings.shipchamber.visual.field.sessionGoal': 'Enable Session Goals',
  'settings.shipchamber.visual.field.sessionGoalAria': 'Keep the session working toward a goal automatically',
  'settings.shipchamber.visual.goal.sectionTitle': 'Goal',
  'settings.shipchamber.visual.goal.budgetLabel': 'Default token budget',
  'settings.shipchamber.visual.goal.budgetAria': 'Apply a default token budget to new goals',
  'settings.shipchamber.visual.goal.description': 'Arm the target button in the composer and the next message becomes a goal: the agent keeps working toward it automatically, audited by the small model, even while you are away.',
  'settings.shipchamber.visual.field.showReasoningTracesAria': 'Show reasoning traces',
  'settings.shipchamber.visual.field.showReasoningTraces': 'Show Reasoning Traces',
  'settings.shipchamber.visual.field.collapsibleThinkingBlocksAria': 'Enable collapsible reasoning blocks',
  'settings.shipchamber.visual.field.collapsibleThinkingBlocks': 'Enable Collapsible Reasoning Blocks',
  'settings.shipchamber.visual.field.collapsibleUserMessagesAria': 'Collapse long user messages',
  'settings.shipchamber.visual.field.collapsibleUserMessages': 'Collapse Long User Messages',
  'settings.shipchamber.visual.field.stickyUserHeaderAria': 'Sticky user header',
  'settings.shipchamber.visual.field.stickyUserHeader': 'Sticky User Header',
  ...
  'settings.shipchamber.visual.field.autoSaveEnabledAria': 'Auto-save files',
  'settings.shipchamber.visual.field.autoSaveEnabled': 'Auto-save files',
  'settings.shipchamber.visual.field.autoSaveEnabledInfo': 'Automatically save file edits after you stop typing. Disable to require manual save.',
  'settings.shipchamber.visual.field.wideChatLayoutAria': 'Wide chat layout',
  'settings.shipchamber.visual.field.wideChatLayout': 'Wide Chat Layout',
  'settings.shipchamber.visual.field.codeBlockLineWrapAria': 'Wrap code block lines',
  'settings.shipchamber.visual.field.codeBlockLineWrap': 'Wrap Code Block Lines',
  'settings.shipchamber.visual.field.showSplitAssistantMessageActionsAria': 'Inline assistant actions',
  'settings.shipchamber.visual.field.showSplitAssistantMessageActions': 'Inline Assistant Actions',
  'settings.shipchamber.visual.field.showSplitAssistantMessageActionsTooltip': 'Show Copy Answer, Save as image, and Read aloud on assistant text blocks that appear before later tool calls in the same response.',
  'settings.shipchamber.visual.field.allowPromptingSubagentSessionsAria': 'Allow prompting subagent sessions',
  'settings.shipchamber.visual.field.allowPromptingSubagentSessions': 'Allow Prompting Subagent Sessions',
  'settings.shipchamber.visual.field.draftStartersVisible': 'Show Starters on New Session Screen',
  'settings.shipchamber.visual.field.draftStartersVisibleAria': 'Show starters on the new session screen',
  'settings.shipchamber.visual.field.showToolFileIconsAria': 'Show tool file icons',
  'settings.shipchamber.visual.field.showToolFileIcons': 'Show Tool File Icons',
  'settings.shipchamber.visual.field.showTurnChangedFilesAria': 'Show changed files for completed turns',
  'settings.shipchamber.visual.field.showTurnChangedFiles': 'Show Changed Files for Completed Turns',
  'settings.shipchamber.visual.field.showDotfilesAria': 'Show dotfiles',
  'settings.shipchamber.visual.field.showDotfiles': 'Show Dotfiles',
  'settings.shipchamber.visual.field.queueMessagesByDefaultAria': 'Queue messages by default',
  'settings.shipchamber.visual.field.queueMessagesByDefault': 'Queue Messages by Default',
  'settings.shipchamber.visual.field.queueMessagesByDefaultTooltip': 'When enabled, Enter queues messages. Use {modifier}+Enter to send.',
  'settings.shipchamber.visual.field.persistDraftMessagesAria': 'Persist draft messages',
  'settings.shipchamber.visual.field.persistDraftMessages': 'Persist Draft Messages',
  'settings.shipchamber.visual.field.enableSpellcheckInTextInputsAria': 'Enable spellcheck in text inputs',
  'settings.shipchamber.visual.field.enableSpellcheckInTextInputs': 'Enable Spellcheck in Text Inputs',
  'settings.shipchamber.visual.field.largeTextPaste': 'Large text paste',
  'settings.shipchamber.visual.field.largeTextPasteHint': 'When pasting more than about 2,000 characters or 25 lines, choose whether to attach the text as a file, paste it inline, or ask each time.',
  'settings.shipchamber.visual.field.enterToSend': 'Enter sends',
  'settings.shipchamber.visual.field.enterToSendHint': 'Once changed, this controls Enter and Shift+Enter on every surface. Until then, each surface keeps its existing behavior.',
  'settings.shipchamber.visual.field.largeTextPasteAria': 'Large text paste behavior',
  'settings.shipchamber.visual.field.largeTextPasteOptionAria': 'Large text paste: {option}',
  'settings.shipchamber.visual.option.largeTextPaste.ask.label': 'Ask each time',
  'settings.shipchamber.visual.option.largeTextPaste.attach.label': 'Attach as file',
  'settings.shipchamber.visual.option.largeTextPaste.inline.label': 'Paste inline',
  'settings.shipchamber.visual.field.sendAnonymousUsageReportsAria': 'Send anonymous usage reports',
  'settings.shipchamber.visual.field.sendAnonymousUsageReports': 'Send anonymous usage reports',
  'settings.shipchamber.visual.field.sendAnonymousUsageReportsHint': 'Helps us understand which app versions are actively used so we can prioritize improvements. Only app version, platform, and runtime are collected - no personal data or code.',
  'settings.shipchamber.visual.option.themeMode.system': 'System',
  'settings.shipchamber.visual.option.themeMode.system.description': 'Follow system setting',
  'settings.shipchamber.visual.option.themeMode.light': 'Light',
  'settings.shipchamber.visual.option.themeMode.light.description': 'Always use light appearance',
  'settings.shipchamber.visual.option.themeMode.dark': 'Dark',
  'settings.shipchamber.visual.option.themeMode.dark.description': 'Always use dark appearance',
  'settings.shipchamber.visual.option.diffLayout.dynamic.label': 'Dynamic',
  'settings.shipchamber.visual.option.diffLayout.dynamic.description': 'New inline, modified side-by-side.',
  'settings.shipchamber.visual.option.diffLayout.inline.label': 'Always inline',
  'settings.shipchamber.visual.option.diffLayout.inline.description': 'Show as a single unified view.',
  'settings.shipchamber.visual.option.diffLayout.sideBySide.label': 'Always side-by-side',
  'settings.shipchamber.visual.option.diffLayout.sideBySide.description': 'Compare original and modified files.',
  'settings.shipchamber.visual.option.mermaidRendering.svg.label': 'SVG',
  'settings.shipchamber.visual.option.mermaidRendering.svg.description': 'Render diagrams as scalable graphics.',
  'settings.shipchamber.visual.option.mermaidRendering.ascii.label': 'ASCII',
  'settings.shipchamber.visual.option.mermaidRendering.ascii.description': 'Render diagrams as text blocks.',
  'settings.shipchamber.visual.option.pwaOrientation.system.label': 'Follow system',
  'settings.shipchamber.visual.option.pwaOrientation.system.description': 'Respect the device rotation setting.',
  'settings.shipchamber.visual.option.pwaOrientation.portrait.label': 'Portrait lock',
  'settings.shipchamber.visual.option.pwaOrientation.portrait.description': 'Install the app locked to portrait.',
  'settings.shipchamber.visual.option.pwaOrientation.landscape.label': 'Landscape lock',
  'settings.shipchamber.visual.option.pwaOrientation.landscape.description': 'Install the app locked to landscape.',
  'settings.shipchamber.visual.option.mobileKeyboardMode.native.label': 'Follow browser',
  'settings.shipchamber.visual.option.mobileKeyboardMode.native.description': 'Use the browser default for panning and viewport changes when the keyboard opens.',
  'settings.shipchamber.visual.option.mobileKeyboardMode.resizeContent.label': 'Resize content',
  'settings.shipchamber.visual.option.mobileKeyboardMode.resizeContent.description': 'Ask supported browsers to shrink the app layout instead of relying only on panning.',
  'settings.shipchamber.visual.option.userMessageRendering.markdown.label': 'Markdown',
  'settings.shipchamber.visual.option.userMessageRendering.markdown.description': 'Render user text with markdown formatting.',
  'settings.shipchamber.visual.option.userMessageRendering.plain.label': 'Plain text',
  'settings.shipchamber.visual.option.userMessageRendering.plain.description': 'Render user text with preserved whitespace and links.',
  'chat.message.userText.collapseAria': 'Collapse user message',
  'settings.shipchamber.visual.option.chatRenderMode.sorted.label': 'Sorted',
  'settings.shipchamber.visual.option.chatRenderMode.sorted.description': 'Render completed assistant messages without live streaming.',
  'settings.shipchamber.visual.option.chatRenderMode.live.label': 'Live',
  'settings.shipchamber.visual.option.chatRenderMode.live.description': 'Stream assistant text and tools as they arrive.',
  'settings.shipchamber.visual.option.messageTransport.auto.label': 'Auto',
  'settings.shipchamber.visual.option.messageTransport.auto.description': 'Prefer WebSocket and fall back to SSE if needed.',
  'settings.shipchamber.visual.option.messageTransport.ws.label': 'WebSocket',
  'settings.shipchamber.visual.option.messageTransport.ws.description': 'Use WebSocket for message streaming.',
  'settings.shipchamber.visual.option.messageTransport.sse.label': 'SSE',
  'settings.shipchamber.visual.option.messageTransport.sse.description': 'Use Server-Sent Events for message streaming.',
  'settings.shipchamber.visual.option.activityRenderMode.collapsed.label': 'Collapsed',
  'settings.shipchamber.visual.option.activityRenderMode.collapsed.description': 'Keep Activity collapsed by default.',
  'settings.shipchamber.visual.option.activityRenderMode.summary.label': 'Expanded',
  'settings.shipchamber.visual.option.activityRenderMode.summary.description': 'Expand Activity by default.',
  'settings.shipchamber.visual.option.timeFormat.auto.label': 'Auto',
  'settings.shipchamber.visual.option.timeFormat.auto.description': 'Use system locale preference.',
  'settings.shipchamber.visual.option.timeFormat.24h.label': '24-hour',
  'settings.shipchamber.visual.option.timeFormat.24h.description': 'Show time as 14:15.',
  'settings.shipchamber.visual.option.timeFormat.12h.label': '12-hour',
  'settings.shipchamber.visual.option.timeFormat.12h.description': 'Show time as 02:15 PM.',
  'settings.shipchamber.visual.option.weekStart.auto.label': 'Auto',
  'settings.shipchamber.visual.option.weekStart.auto.description': 'Use locale week start.',
  'settings.shipchamber.visual.option.weekStart.monday.label': 'Monday',
  'settings.shipchamber.visual.option.weekStart.sunday.label': 'Sunday',
  ...
  'settings.shipchamber.visual.field.inputHistoryScope': 'Input history scope',
  'settings.shipchamber.visual.field.inputHistoryScopeDescription': 'Choose whether submitted prompts are recalled across all projects connected to this runtime or only in the current session.',
  'settings.shipchamber.visual.section.inputHistoryScopeAria': 'Input history scope',
  'settings.shipchamber.visual.option.inputHistoryScope.global.label': 'All projects',
  'settings.shipchamber.visual.option.inputHistoryScope.session.label': 'Current session',
  'settings.shipchamber.visual.field.inputHistoryLimit': 'Prompts to remember',
  'settings.shipchamber.visual.field.inputHistoryLimitDescription': 'Lowering this number removes older prompts from your history.',
  'settings.shipchamber.visual.field.inputHistoryLimitAria': 'Prompts to remember',
  ...
  'settings.page.integrations.description': 'Connect GitHub and Linear so ShipChamber can work with your issues and pull requests.',
  'settings.license.title': 'License',
  'settings.license.info': 'ShipChamber is free to use. A one-time Lifetime license unlocks the private relay for phone and remote access, multi-run comparisons, session goals and guided walkthroughs on this instance.',
  'settings.license.tier.free': 'Free',
  'settings.license.tier.lifetime': 'Lifetime',
  'settings.license.state.active': 'Lifetime license {key} is active on this instance.',
  'settings.license.field.key.label': 'License key',
  'settings.license.field.key.description': 'Paste the key from your purchase receipt. It is validated by the ShipChamber license server and stored on this instance only.',
  'settings.license.actions.activate': 'Activate',
  'settings.license.actions.deactivate': 'Remove license from this instance',
  'settings.license.actions.buy': 'Get a Lifetime license',
  'settings.license.toast.activated': 'Lifetime license activated',
  'settings.license.toast.activateFailed': 'Could not activate the license',
  'settings.license.toast.deactivated': 'License removed',
  'settings.license.toast.deactivateFailed': 'Could not remove the license',
  'settings.license.upgrade.title': 'Lifetime feature',
  'settings.license.upgrade.body': 'This feature is part of ShipChamber Lifetime. Activate a license under Settings → About, or get one on shipchamber.com.',
  'settings.license.upgrade.open': 'Open license settings',
} as const;
