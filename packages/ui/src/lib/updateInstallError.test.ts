...
describe('classifyUpdateInstallError', () => {
  test('recognizes a rejected code signature', () => {
    const error = new Error(
      'Code signature at URL file:///Users/me/Library/Caches/dev.shipchamber.desktop.ShipIt/update.afN56TW/ShipChamber.app/ did not pass validation: code failed to satisfy specified code requirement(s)',
    );
