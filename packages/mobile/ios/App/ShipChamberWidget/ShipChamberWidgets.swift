...
struct OverviewWidget: Widget {
    ...
    var body: some WidgetConfiguration {
        ...
        .configurationDisplayName("ShipChamber")
...
struct QuickActionsWidget: Widget {
    let kind = "ShipChamberQuickActions"
...
struct LockAttentionWidget: Widget {
    let kind = "ShipChamberLockAttention"
...
@main
struct ShipChamberWidgetBundle: WidgetBundle {
