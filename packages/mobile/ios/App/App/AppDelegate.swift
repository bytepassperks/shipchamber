...
class BridgeViewController: CAPBridgeViewController {
    ...
    override func capacitorDidLoad() {
        ...
        let source = """
        window.__SHIPCHAMBER_APNS_ENV__ = '\(apnsEnvironment)';
        window.__SHIPCHAMBER_HARDWARE_KEYBOARD__ = \(attached ? "true" : "false");
        """
    ...
    private func publishHardwareKeyboardState(_ attached: Bool) {
        ...
        window.__SHIPCHAMBER_HARDWARE_KEYBOARD__ = \(value);
...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private static let widgetAppGroup = "group.com.shipchamber.app"
    private static let widgetSnapshotKey = "widgetSnapshot"

    /// Pulls the session overview JSON from the web layer (window.__SHIPCHAMBER_WIDGET_SNAPSHOT__),
    ...
    private func writeWidgetSnapshot() {
        ...
        let js = "(typeof window.__SHIPCHAMBER_WIDGET_SNAPSHOT__ === 'function') ? window.__SHIPCHAMBER_WIDGET_SNAPSHOT__() : null"
