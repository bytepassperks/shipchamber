# ShipChamber Docs Source

This package is the source-of-truth for ShipChamber public docs content.
...
Website rendering/deployment happens in `shipchamber-website` (`apps/docs`).
