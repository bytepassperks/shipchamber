...
## O comando ShipChamber encerra ou não inicia

- confirme o Node.js `>=22`
- execute `shipchamber --version`
- reinstale a CLI mais recente se necessário

## A UI web não está acessível

- verifique os logs do servidor com `shipchamber logs`
...
- confirme que o servidor do ShipChamber está em execução
