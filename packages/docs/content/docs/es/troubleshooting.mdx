...
## El comando ShipChamber se cierra o no arranca

- confirma que Node.js es `>=22`
- ejecuta `shipchamber --version`
- reinstala la última CLI si hace falta

## No se puede acceder a la UI web

- revisa los logs del servidor con `shipchamber logs`
...
- confirma que el servidor de ShipChamber está en marcha
