---
title: Quickstart
description: Start ShipChamber quickly and pick the right app for the task.
---
...
2. Install the ShipChamber CLI (see [Install](/install/) for the one-line command).
...
You should see the ShipChamber session list in your browser. If it loads, you're up and running.
