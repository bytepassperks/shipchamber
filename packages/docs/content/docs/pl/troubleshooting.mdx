...
## Polecenie ShipChamber kończy się lub nie uruchamia

- upewnij się, że Node.js `>=22`
- uruchom `shipchamber --version`
- w razie potrzeby zainstaluj ponownie najnowsze CLI

## Webowy interfejs jest nieosiągalny

- sprawdź logi serwera poleceniem `shipchamber logs`
...
- upewnij się, że serwer ShipChamber działa
