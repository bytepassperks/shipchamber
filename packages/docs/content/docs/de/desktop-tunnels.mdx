...
Die Desktop-App kann unter **Settings → ShipChamber → Tunnel** einen öffentlichen Tunnel erstellen. Für diesen Weg musst du ShipChamber nicht per CLI starten.

## Anbieter installieren

ShipChamber startet das Provider-CLI auf deinem Rechner. Installiere zuerst den Anbieter, den du verwenden möchtest:
...
1. Öffne **Settings → ShipChamber → Tunnel**.
