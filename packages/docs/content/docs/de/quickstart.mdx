---
title: Schnellstart
description: Starte ShipChamber schnell und wähle die richtige App für die Aufgabe.
---
...
2. Installiere das ShipChamber-CLI (siehe [Installieren](/install/) für den Einzeilenbefehl).
3. Führe `shipchamber --ui-password be-creative-here` aus.
...
Du solltest die ShipChamber-Session-Liste in deinem Browser sehen. Wenn sie geladen wird, bist du startklar.
