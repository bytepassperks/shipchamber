---
title: Reverse Proxy
description: Konfigurieren Sie ShipChamber korrekt hinter Nginx, Nginx Proxy Manager oder einem anderen Reverse Proxy.
---

# Reverse Proxy

Nutzen Sie diese Seite, wenn ShipChamber hinter Nginx, Nginx Proxy Manager, Caddy, Cloudflare oder einem anderen Reverse Proxy läuft.

## Bevor Sie es proxyen

1. Bestätigen Sie zuerst, dass ShipChamber direkt funktioniert.
...
- Deaktivieren Sie gzip auf dem Proxy, wenn ShipChamber Antworten bereits komprimiert.
...
- ShipChamber direkt im LAN erreichbar
...
- ShipChamber komprimiert HTTP-Antworten mit gzip (Schwelle 1 KB).
...
SSE-Streaming-Routen sind von ShipChamber von der Komprimierung ausgeschlossen, das CDN kann sie aber trotzdem puffern. Prüfen Sie in der CDN-Dokumentation, wie sich Buffering auf SSE-Pfaden deaktivieren lässt.
