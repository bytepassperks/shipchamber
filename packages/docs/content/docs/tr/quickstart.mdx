...
description: ShipChamber'ı hızlıca başlatın ve iş için doğru uygulamayı seçin.
---
...
2. ShipChamber CLI'yı yükleyin. Tek satırlık komut için [Install](/install/) sayfasına bakın.
3. `shipchamber --ui-password be-creative-here` komutunu çalıştırın.
...
Tarayıcınızda ShipChamber oturum listesini görmelisiniz. Yüklendiyse çalışıyordur.
