---
title: Ses Modu
description: ShipChamber ile konuşun ve yanıtları sesli dinleyin.
---

# Ses Modu

Ses modu, mesajları dikte etmenizi ve yanıtları size geri okutmanızı sağlar. Bunu **Settings → ShipChamber → Voice** bölümünden açın.
