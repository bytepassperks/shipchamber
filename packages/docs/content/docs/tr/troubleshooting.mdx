...
## ShipChamber komutu kapanıyor ya da başlamıyor

- Node.js sürümünün `>=22` olduğunu doğrulayın
- `shipchamber --version` çalıştırın
- Gerekirse en son CLI'yı yeniden kurun

## Web arayüzüne ulaşılamıyor

- Sunucu günlüklerini `shipchamber logs` ile kontrol edin
...
- ShipChamber sunucusunun çalıştığını doğrulayın
