...
Agent durup oturum bir süre sessiz kaldıktan sonra ShipChamber şunları yapar:
...
- Hedef döngüsü tarayıcı sekmesinde değil, ShipChamber sunucusunda çalışır. Sekmeyi kapatsanız da telefonu kilitleseniz de agent çalışmaya devam eder ve hedef yerleştiğinde bildirim alırsınız. Sunucu, masaüstü uygulaması ya da `shipchamber` süreci, açık kalmalıdır.
