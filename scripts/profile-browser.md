...
Start ShipChamber locally, then run:
...
measure, then return to the terminal and press Enter. Use ShipChamber normally
...
bun run profile:browser -- --output /tmp/shipchamber-profile
