...
/**
 * VS Code Theme to ShipChamber Theme Converter
 * 
 * USAGE:
 ...
 *   2. Converts it to ShipChamber theme format:
...
function convertVsCodeTheme(vscodeThemePath) {
  ...
  // Build ShipChamber theme
  const shipchamberTheme = {
    metadata: {
