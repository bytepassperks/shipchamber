...
const uiPort = process.env.SHIPCHAMBER_HMR_UI_PORT || '5180';
const backendPort = process.env.SHIPCHAMBER_HMR_API_PORT || '3902';
const hmrHost = process.env.SHIPCHAMBER_HMR_HOST || '127.0.0.1';
...
const api = run(
  ...
  ],
  {
    ...
    SHIPCHAMBER_RELAY_HOST: process.env.SHIPCHAMBER_RELAY_HOST || 'off',
  },
);
const vite = run(
  'vite',
