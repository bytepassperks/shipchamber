...
export const IDLE_PROBE_GLOBAL = "__shipchamberIdleProbe"

const probeFactory = function installShipchamberIdleProbe(globalName, stackCaptureBudget) {
  ...
  const siteFromStack = (kind) => {
    ...
    for (const line of lines) {
      ...
      if (line.includes("installShipchamberIdleProbe")) continue
