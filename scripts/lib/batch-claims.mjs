...
// configuration. Override with --claims-dir or SHIPCHAMBER_BATCH_CLAIMS_DIR
// only when a working copy must be isolated, for example while experimenting.

const DAY_MS = 24 * 60 * 60 * 1000;
const SHARED_CLAIMS_ENV = "SHIPCHAMBER_BATCH_CLAIMS_DIR";
const DEFAULT_CLAIMS_DIR = join(homedir(), ".shipchamber", "maintenance-claims");
